...
"} array/fill! (a b) #@(documentation: \"Append array A to array B\" name: array/append) #{##(:array :type-name a b :type-error \"array/append expects two arrays as its arguments\" current-lambda array/allocate :length ret i rl)\n"
...
"} compile (name args body) #@(name: meta/parse/body cat: :compiler internal: #t) #{##(body source tree/new :name name meta v :type-name ΓεnΣym-3 :pair deftest :tests :string :documentation cat string \"\\n\" :keyword ΓεnΣym-4 :inline :source :related :export-as :export :cat trim join map split)\n"
"0E0007010D0E021A030E04040207050D240900E70D0E001107060D151A070E06\n"
...
"}#{##((kw) #@(documentation: \"Convert a keyword into a string\\n\\nkw: The input keyword\\n\\nReturns the string for kw\" name: keyword->string cat: :type-conversion tests: ((\"asd\" (keyword->string :asd))) related: (string->keyword)) #{##(:keyword :type-name kw :type-error \"(keyword->string) can only be called on keywords\" current-lambda string keyword->symbol)\n"
"1A001A010E020401200B0007240900101A031A040E020E0504002E042F0D0E06\n"
"0E070E020401040101\n"
"} keyword->string (kw) #@(documentation: \"Convert a string into a keyword\\n\\nkw: The input string\\n\\nReturns the keyword for kw\" name: string->keyword cat: :type-conversion tests: ((:asd (string->keyword \"asd\"))) related: (keyword->string)) #{##(:string :type-name kw :type-error \"(string->keyword) can only be called on strings\" current-lambda symbol->keyword string->symbol)\n"
"1A001A010E020401200B0007240900101A031A040E020E0504002E042F0D0E06\n"
"0E070E020401040101\n"
"} string->keyword)\n"
...
"} module/restore-state (module-name symbol) #@(name: module/qualify-symbol cat: :modules internal: #t) #{##(:type-name module-name ΓεnΣym-1 :string module/qualify-symbol string->keyword symbol :keyword string->symbol cat keyword->symbol \"/\" string \"Can't qualify that\" current-lambda)\n"
"151A000E01040107020D0E021A03200B00120E040E050E0104010E0604020900\n"
"300E021A07200B001C0E080E090E0A0E0104011A0B0E0C0E0604010403040109\n"
"000F1A0D0E01240E0E04002E042F1601\n"
"} module/qualify-symbol (module env qualify?) #@(name: require* cat: :modules internal: #t) #{##(module/load module env mod \"Can't load that module\" current-lambda resolve exports :keys ΓεnΣym-6 k def-in! qualify? module/qualify-symbol keyword->symbol)\n"
...
"} not-equal? (val) #@(documentation: \"Test whether val is an integer\\n\\nInteger are sometimes called fixnum's as well\\n\\nval: This argument is going to be tested\\n\\nWhether val is an integer\" name: int? source: (\"Test whether val is an integer\\n\\n      Integer are sometimes called fixnum's as well\\n\\n      val: This argument is going to be tested\\n\\n      Whether val is an integer\" :cat :type-predicate (deftest #t (int? 123)) (deftest #f (int? 123.123)) (deftest #f (int? 'asd)) :inline (= :int (:type-name val))) cat: :type-predicate tests: ((#f (int? 'asd)) (#f (int? 123.123)) (#t (int? 123))) inline: #t) #{##(:int :type-name val)\n"
"1A001A010E0204012001\n"
"} int? (val) #@(documentation: \"Test whether val is a floating-point number\\n\\nFloat's are sometimes called flonum's as well\\n\\nval: This argument is going to be tested\\n\\nWhether val is a floating-point number\" name: float? source: (\"Test whether val is a floating-point number\\n\\n      Float's are sometimes called flonum's as well\\n\\n      val: This argument is going to be tested\\n\\n      Whether val is a floating-point number\" :cat :type-predicate (deftest #f (float? 123)) (deftest #t (float? 123.123)) (deftest #f (float? 'abc)) :inline (= :float (:type-name val))) cat: :type-predicate tests: ((#f (float? 'abc)) (#t (float? 123.123)) (#f (float? 123))) inline: #t) #{##(:float :type-name val)\n"
"1A001A010E0204012001\n"
...
"} number? (val) #@(documentation: \"Test whether val is a boolean\\n\\nval: This argument is going to be tested\\n\\nWhether val is a boolean\" name: bool? source: (\"Test whether val is a boolean\\n\\n      val: This argument is going to be tested\\n\\n      Whether val is a boolean\" :cat :type-predicate (deftest #t (bool? #t)) (deftest #t (bool? #f)) (deftest #f (bool? #nil)) (deftest #f (bool? 123)) (deftest #f (bool? 123.123)) (deftest #f (bool? 'qwe)) :inline (= :bool (:type-name val))) cat: :type-predicate tests: ((#f (bool? 'qwe)) (#f (bool? 123.123)) (#f (bool? 123)) (#f (bool? #nil)) (#t (bool? #f)) (#t (bool? #t))) inline: #t) #{##(:bool :type-name val)\n"
"1A001A010E0204012001\n"
"} bool? (val) #@(documentation: \"Test whether val is a pair\\n\\nA pair is sometimes also called a cons cell, which can be used to build lists and much more.\\n\\nval: This argument is going to be tested\\n\\nWhether val is a pair\" name: pair? source: (\"Test whether val is a pair\\n\\n      A pair is sometimes also called a cons cell, which can be used to build lists and much more.\\n\\n      val: This argument is going to be tested\\n\\n      Whether val is a pair\" :cat :type-predicate (deftest #t (pair? '(#nil))) (deftest #t (pair? '(123))) (deftest #f (pair? 123)) (deftest #f (pair? 123.123)) (deftest #f (pair? 'qwe)) :inline (= :pair (:type-name val))) cat: :type-predicate tests: ((#f (pair? 'qwe)) (#f (pair? 123.123)) (#f (pair? 123)) (#t (pair? '(123))) (#t (pair? '(#nil)))) inline: #t) #{##(:pair :type-name val)\n"
"1A001A010E0204012001\n"
"} pair? (val) #@(documentation: \"Test whether val is an array\\n\\nSometimes also called a vector.\\n\\nval: This argument is going to be tested\\n\\nWhether val is an array\" name: array? source: (\"Test whether val is an array\\n\\n      Sometimes also called a vector.\\n\\n      val: This argument is going to be tested\\n\\n      Whether val is an array\" :cat :type-predicate (deftest #t (array? (array/new #nil))) (deftest #f (array? '(123))) (deftest #f (array? 123)) (deftest #f (array? 123.123)) (deftest #f (array? 'abc)) :inline (= :array (:type-name val))) cat: :type-predicate tests: ((#f (array? 'abc)) (#f (array? 123.123)) (#f (array? 123)) (#f (array? '(123))) (#t (array? (array/new #nil)))) inline: #t) #{##(:array :type-name val)\n"
"1A001A010E0204012001\n"
"} array? (val) #@(documentation: \"Test whether val is a string\\n\\nval: This argument is going to be tested\\n\\nWhether val is a string\" name: string? source: (\"Test whether val is a string\\n\\n      val: This argument is going to be tested\\n\\n      Whether val is a string\" :cat :type-predicate (deftest #t (string? \"asd\")) (deftest #f (string? (array/new #nil))) (deftest #f (string? '(123))) (deftest #f (string? 123)) (deftest #f (string? 123.123)) (deftest #f (string? 'abc)) :inline (= :string (:type-name val))) cat: :type-predicate tests: ((#f (string? 'abc)) (#f (string? 123.123)) (#f (string? 123)) (#f (string? '(123))) (#f (string? (array/new #nil))) (#t (string? \"asd\"))) inline: #t) #{##(:string :type-name val)\n"
"1A001A010E0204012001\n"
"} string? (val) #@(documentation: \"Test whether val is a symbol\\n\\nval: This argument is going to be tested\\n\\nWhether val is a symbol\" name: symbol? source: (\"Test whether val is a symbol\\n\\n      val: This argument is going to be tested\\n\\n      Whether val is a symbol\" :cat :type-predicate (deftest #t (symbol? 'abc)) (deftest #f (symbol? \"asd\")) (deftest #f (symbol? '(123))) (deftest #f (symbol? 123)) (deftest #f (symbol? 123.123)) :inline (= :symbol (:type-name val))) cat: :type-predicate tests: ((#f (symbol? 123.123)) (#f (symbol? 123)) (#f (symbol? '(123))) (#f (symbol? \"asd\")) (#t (symbol? 'abc))) inline: #t) #{##(:symbol :type-name val)\n"
"1A001A010E0204012001\n"
"} symbol? (val) #@(documentation: \"Test whether val is an environment\\n\\nSometimes also called a closure\\n\\nval: This argument is going to be tested\\n\\nWhether val is an environment\" name: environment? source: (\"Test whether val is an environment\\n\\n      Sometimes also called a closure\\n\\n      val: This argument is going to be tested\\n\\n      Whether val is an environment\" :cat :type-predicate (deftest #t (environment? (current-closure))) (deftest #f (environment? (array/new #nil))) (deftest #f (environment? '(123))) :inline (= :environment (:type-name val))) cat: :type-predicate tests: ((#f (environment? '(123))) (#f (environment? (array/new #nil))) (#t (environment? (current-closure)))) inline: #t) #{##(:environment :type-name val)\n"
"1A001A010E0204012001\n"
"} environment? (val) #@(documentation: \"Test whether val is a binary tree\\n\\nTrees can also be used as maps, tuples or '\\n\\nval: This argument is going to be tested\\n\\nWhether val is a tree\" name: tree? source: (\"Test whether val is a binary tree\\n\\n      Trees can also be used as maps, tuples or '\\n\\n      val: This argument is going to be tested\\n\\n      Whether val is a tree\" :cat :type-predicate (deftest #t (tree? (tree/new #nil))) (deftest #f (tree? (current-closure))) (deftest #f (tree? (array/new #nil))) (deftest #f (tree? '(123))) (deftest #f (tree? 123)) (deftest #f (tree? 123.123)) (deftest #f (tree? 'abc)) :inline (= :tree (:type-name val))) cat: :type-predicate tests: ((#f (tree? 'abc)) (#f (tree? 123.123)) (#f (tree? 123)) (#f (tree? '(123))) (#f (tree? (array/new #nil))) (#f (tree? (current-closure))) (#t (tree? (tree/new #nil)))) inline: #t) #{##(:tree :type-name val)\n"
"1A001A010E0204012001\n"
"} tree? (l) #@(documentation: \"Test whether val is a collection\\n\\nval: This argument is going to be tested\\n\\nWhether val is a collection\" name: collection? source: (\"Test whether val is a collection\\n\\n      val: This argument is going to be tested\\n\\n      Whether val is a collection\" :cat :type-predicate (deftest #t (collection? (tree/new #nil))) (deftest #t (collection? (array/new #nil))) (deftest #t (collection? '(123))) (deftest #f (collection? (current-closure))) (deftest #f (collection? 123)) (deftest #f (collection? 123.123)) (deftest #f (collection? 'abc)) :inline (case (:type-name l) ((:pair :array :tree) #t) (otherwise #f))) cat: :type-predicate tests: ((#f (collection? 'abc)) (#f (collection? 123.123)) (#f (collection? 123)) (#f (collection? (current-closure))) (#t (collection? '(123))) (#t (collection? (array/new #nil))) (#t (collection? (tree/new #nil)))) inline: #t) #{##(:type-name l ΓεnΣym-14 :pair :array :tree #f)\n"
"151A000E01040107020D0E021A03200C0A001A0D0E021A04200C0A00100D0E02\n"
"1A05200C0A00060D1A060B00071B0900041C1601\n"
"} collection? (v) #@(documentation: \"Test whether val is a keyword\\n\\nval: This argument is going to be tested\\n\\nWhether val is a keyword\" name: keyword? source: (\"Test whether val is a keyword\\n\\n      val: This argument is going to be tested\\n\\n      Whether val is a keyword\" :cat :type-predicate (deftest #t (keyword? :abc)) (deftest #f (keyword? 'abc)) (deftest #f (keyword? \"asd\")) (deftest #f (keyword? (array/new #nil))) (deftest #f (keyword? '(123))) (deftest #f (keyword? 123)) (deftest #f (keyword? 123.123)) :inline (= :keyword (:type-name v))) cat: :type-predicate tests: ((#f (keyword? 123.123)) (#f (keyword? 123)) (#f (keyword? '(123))) (#f (keyword? (array/new #nil))) (#f (keyword? \"asd\")) (#f (keyword? 'abc)) (#t (keyword? :abc))) inline: #t) #{##(:keyword :type-name v)\n"
"1A001A010E0204012001\n"
"} keyword? (val) #@(documentation: \"Test whether val is a macro\\n\\nval: This argument is going to be tested\\n\\nWhether val is a macro\" name: macro? source: (\"Test whether val is a macro\\n\\n      val: This argument is going to be tested\\n\\n      Whether val is a macro\" :cat :type-predicate (deftest #t (macro? case)) (deftest #f (macro? :abc)) :inline (= :macro (:type-name val))) cat: :type-predicate tests: ((#f (macro? :abc)) (#t (macro? case))) inline: #t) #{##(:macro :type-name val)\n"
"1A001A010E0204012001\n"
"} macro? (val) #@(documentation: \"Test whether val is a function\\n\\nSometimes also called lambda or subroutine\\n\\nval: This argument is going to be tested\\n\\nWhether val is a function\" name: lambda? source: (\"Test whether val is a function\\n\\n      Sometimes also called lambda or subroutine\\n\\n      val: This argument is going to be tested\\n\\n      Whether val is a function\" :cat :type-predicate (deftest #t (lambda? min)) (deftest #f (lambda? case)) (deftest #f (lambda? (current-closure))) (deftest #f (lambda? 'abc)) :inline (or (= :lambda (:type-name val)))) cat: :type-predicate tests: ((#f (lambda? 'abc)) (#f (lambda? (current-closure))) (#f (lambda? case)) (#t (lambda? min))) inline: #t) #{##(:lambda :type-name val #f)\n"
"1A001A010E020401200C0A00060D1A0301\n"
"} lambda? (val) #@(documentation: \"Test whether val is a native function\\n\\nSometimes also called lambda or subroutine\\n\\nval: This argument is going to be tested\\n\\nWhether val is a native function\" name: native? source: (\"Test whether val is a native function\\n\\n      Sometimes also called lambda or subroutine\\n\\n      val: This argument is going to be tested\\n\\n      Whether val is a native function\" :cat :type-predicate (deftest #t (native? sin)) (deftest #f (native? (defn +123 (a) (+ a 123)))) (deftest #f (native? (defmacro +123 (a) (+ a 123)))) :inline (= :native-function (:type-name val))) cat: :type-predicate tests: ((#f (native? (defmacro +123 (a) (+ a 123)))) (#f (native? (defn +123 (a) (+ a 123)))) (#t (native? sin))) inline: #t) #{##(:native-function :type-name val)\n"
"1A001A010E0204012001\n"
"} native? (v) #@(documentation: \"Test whether val is a buffer\\n\\nBuffers are just modifiable chunks of memory\\n\\nval: This argument is going to be tested\\n\\nWhether val is a buffer\" name: buffer? source: (\"Test whether val is a buffer\\n\\n      Buffers are just modifiable chunks of memory\\n\\n      val: This argument is going to be tested\\n\\n      Whether val is a buffer\" :cat :type-predicate (deftest #t (buffer? #m00)) (deftest #f (buffer? \"asd\")) (deftest #f (buffer? (array/new #nil))) :inline (= :buffer (:type-name v))) cat: :type-predicate tests: ((#f (buffer? (array/new #nil))) (#f (buffer? \"asd\")) (#t (buffer? #m00))) inline: #t) #{##(:buffer :type-name v)\n"
"1A001A010E0204012001\n"
"} buffer? (v) #@(documentation: \"Test whether val is a buffer view\\n\\nval: This argument is going to be tested\\n\\nWhether val is a buffer view\" name: buffer-view? source: (\"Test whether val is a buffer view\\n\\n      val: This argument is going to be tested\\n\\n      Whether val is a buffer view\" :cat :type-predicate (deftest #t (buffer-view? (buffer/u8* #m00))) (deftest #f (buffer-view? #m00)) (deftest #f (buffer-view? \"asd\")) (deftest #f (buffer-view? (array/new #nil))) :inline (= :buffer-view (:type-name v))) cat: :type-predicate tests: ((#f (buffer-view? (array/new #nil))) (#f (buffer-view? \"asd\")) (#f (buffer-view? #m00)) (#t (buffer-view? (buffer/u8* #m00)))) inline: #t) #{##(:buffer-view :type-name v)\n"
"1A001A010E0204012001\n"
...
"} closure/name (o) #@(documentation: \"Describe a specific value O\" name: describe/thing) #{##(closure/documentation o documentation closure/name name print fmt-arg-0 cat \"(\" closure/arguments arguments :pair :type-name ΓεnΣym-21 arg \" \" println \")\" \" . \" \"\\n\")\n"
...
"1A001A010E020401200C0A00140D1A031A010E020401200C0A00060D1A0401\n"
"} fmt/valid-argument? (v) #@(name: fmt/arg-sym) #{##(:type-name v ΓεnΣym-73 :int fmt/arg-sym cat \"fmt-arg-\" string :symbol :string string->symbol :type-error \"Invalid fmt argument name\" current-lambda)\n"
"151A000E01040107020D0E021A03200B00160E040E051A060E070E0104010402\n"
...
"150E0607170D2409005C0D0E171107180D1A190E020E18120201250E0F040307\n"
"1A0D1A1B0E1A200B00072409000A0E1A0E0E14050E0D0E1C1A190E0202010E18\n"
"11250E181204030E130E160403071D0D0E1D0E0E14050E0D0E1811050F0D0E17\n"
"1205170E170AFFA50D24160D0E0F0200220B001A1A190E0202000E0F0403071A\n"
...
"0D0E1304011E0AFFD00D240D0E0E120B000B1A1F0E0E1409001B1A001A010E0E\n"
...
"} write/raw/bytecode-array (v port hr? always-space?) #@(name: write/raw/tree/rec) #{##(v :key* #f always-space? write/raw/tree/rec :left* port hr? block-write \" \" keyword->string \": \" write/raw :value* :right*)\n"
...
"000E0E061A081A090402090004240D0E061A080E0A1A010E000401040104020D\n"
...
"0D0D1A0A0E0404010E0B260E0D26070E0D1A0F0E040E0E0E0E0E0B2504031609\n"
"00050E0401\n"
