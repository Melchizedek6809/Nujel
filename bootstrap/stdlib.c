...
"}#{##((c i) #@(name: describe/closure cat: :compiler internal: #t) #{##(c root-closure cat i \"# <root environment>\" closure/data data :length l int #f \"# \" string/write \" - \" :*module* \"-+- Very big tree structure -+-\")\n"
"0E000B00670E000E01200B000E0E020E031A0404020900510E050E0004010706\n"
