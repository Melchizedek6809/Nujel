...
"} cdr! (v l) #@(documentation: \"Cons V onto L and set! the value for L\" name: cons!) #{##(set! l cons v)\n"
...
"} last-pair (end start step) #@(documentation: \"Return a list containing values from START (inclusive) to END (exclusive) by STEP\" name: range) #{##(end throw :arity-error \"(range) needs at least a specific end\" current-lambda start step 0.0 < > pred ret nreverse)\n"
...
"} range (l o s) #@(documentation: \"Combine all elements in l using operation o and starting value s\" name: list/reduce) #{##(l ΓεnΣym-15 e o s)\n"
"150E0007010D2409001A0D0E011107020D0E030E040E02040205040D0E011205\n"
"010E010AFFE70D0E041601\n"
"} list/reduce (l) #@(documentation: \"Return the list l in reverse order\" name: reverse) #{##(ret l ΓεnΣym-18 e)\n"
"2407000D150E0107020D240900170D0E021107030D0E030E001405000D0E0212\n"
"05020E020AFFEA0D0E001601\n"
"} reverse (l) #@(documentation: \"Returns the length of list l\" name: list/length) #{##(ret l ΓεnΣym-21 e)\n"
"020007000D150E0107020D240900170D0E021107030D0E0002012505000D0E02\n"
"1205020E020AFFEA0D0E001601\n"
"} list/length (l p) #@(documentation: \"Runs predicate p over every item in list l and returns a list consiting solely of items where p is true\" name: list/filter) #{##(ret l ΓεnΣym-24 e p nreverse)\n"
...
"} list/filter (l f) #@(documentation: \"Runs f over every item in list l and returns the resulting list\" name: list/map) #{##(ret l ΓεnΣym-29 e f nreverse)\n"
"2407000D150E0107020D2409001B0D0E021107030D0E040E0304010E00140500\n"
"0D0E021205020E020AFFE60D0E050E0004011601\n"
"} list/map (a b) #@(documentation: \"Appends two lists A and B together\" name: append) #{##(b ret reverse a ΓεnΣym-32 t)\n"
...
"} list/replace)\n"
"1A001A011A021807030D1A041A051A061807070D151A081A091A0A17070B0D1A\n"
"0C1A0D1A0E17070F16070F0D1A101A111A121707130D1A141A151A161707170D\n"
...
"1A0001\n"
"} $add/int (#nil) #@(documentation: \"(col key) -> (result) --- Looks up key in col\" name: $ref source: (\"(col key) -> (result) --- Looks up key in col\" :cat :bytecode :internal :inline '(#$2B)) cat: :bytecode internal: #t inline: #t) #{##((#$2B))\n"
"1A0001\n"
"} $ref (#nil) #@(documentation: \"(a) -> (a a) --- Duplicates the value that is on the top of the stack\" name: $dup source: (\"(a) -> (a a) --- Duplicates the value that is on the top of the stack\" :cat :bytecode :internal :inline '(#$C)) cat: :bytecode internal: #t inline: #t) #{##((#$C))\n"
"1A0001\n"
"} $dup (#nil) #@(documentation: \"(a) -> () --- Drop whatever is on top of the stack\" name: $drop source: (\"(a) -> () --- Drop whatever is on top of the stack\" :cat :bytecode :internal :inline '(#$D)) cat: :bytecode internal: #t inline: #t) #{##((#$D))\n"
"1A0001\n"
"} $drop (#nil) #@(documentation: \"() -> (closure) --- Push the current closure as a λ on the stack\" name: $closure/push source: (\"() -> (closure) --- Push the current closure as a λ on the stack\" :cat :bytecode :internal :inline '(#$13)) cat: :bytecode internal: #t inline: #t) #{##((#$13))\n"
"1A0001\n"
"} $closure/push (#nil) #@(documentation: \"() -> () --- Create a new let closure and switch to it\" name: $let source: (\"() -> () --- Create a new let closure and switch to it\" :cat :bytecode :internal :inline '(#$15)) cat: :bytecode internal: #t inline: #t) #{##((#$15))\n"
"1A0001\n"
"} $let (#nil) #@(documentation: \"() -> () --- Leave the current closure and return to the parent one\" name: $closure/pop source: (\"() -> () --- Leave the current closure and return to the parent one\" :cat :bytecode :internal :inline '(#$16)) cat: :bytecode internal: #t inline: #t) #{##((#$16))\n"
"1A0001\n"
"} $closure/pop (#nil) #@(documentation: \"(a b) -> (bool) --- Compare A and B and push the result on the stack\" name: $< source: (\"(a b) -> (bool) --- Compare A and B and push the result on the stack\" :cat :bytecode :internal :inline '(#$1E)) cat: :bytecode internal: #t inline: #t) #{##((#$1E))\n"
"1A0001\n"
...
"1A0001\n"
"} $> (#nil) #@(documentation: \"() -> (nil) --- Push a #nil on the stack\" name: $push/nil source: (\"() -> (nil) --- Push a #nil on the stack\" :cat :bytecode :internal :inline '(#$24)) cat: :bytecode internal: #t inline: #t) #{##((#$24))\n"
"1A0001\n"
"} $push/nil (#nil) #@(documentation: \"(l) -> (car) --- Replace L with its car\" name: $car source: (\"(l) -> (car) --- Replace L with its car\" :cat :bytecode :internal :inline '(#$11)) cat: :bytecode internal: #t inline: #t) #{##((#$11))\n"
"1A0001\n"
"} $car (#nil) #@(documentation: \"(l) -> (cdr) --- Replace L with its cdr\" name: $cdr source: (\"(l) -> (cdr) --- Replace L with its cdr\" :cat :bytecode :internal :inline '(#$12)) cat: :bytecode internal: #t inline: #t) #{##((#$12))\n"
"1A0001\n"
"} $cdr (#nil) #@(documentation: \"(l) -> (cadr) --- Replace L with its cadr\" name: $cadr source: (\"(l) -> (cadr) --- Replace L with its cadr\" :cat :bytecode :internal :inline '(#$2C)) cat: :bytecode internal: #t inline: #t) #{##((#$2C))\n"
"1A0001\n"
"} $cadr (#nil) #@(documentation: \"(car cdr) -> (pair) --- Cons CAR and CDR together and put it on the stack\" name: $cons source: (\"(car cdr) -> (pair) --- Cons CAR and CDR together and put it on the stack\" :cat :bytecode :internal :inline '(#$14)) cat: :bytecode internal: #t inline: #t) #{##((#$14))\n"
"1A0001\n"
"} $cons (#nil) #@(documentation: \"(args meta body) -> (λ) --- Create a new λ\" name: $fn/new source: (\"(args meta body) -> (λ) --- Create a new λ\" :cat :bytecode :internal :inline '(#$17)) cat: :bytecode internal: #t inline: #t) #{##((#$17))\n"
"1A0001\n"
"} $fn/new (#nil) #@(documentation: \"(args meta body) -> (μ) --- Create a new μ\" name: $macro/new source: (\"(args meta body) -> (μ) --- Create a new μ\" :cat :bytecode :internal :inline '(#$18)) cat: :bytecode internal: #t inline: #t) #{##((#$18))\n"
"1A0001\n"
"} $macro/new (#nil) #@(documentation: \"(name args docs body) -> (λ) --- Create a new λ\" name: $fn/dynamic source: (\"(name args docs body) -> (λ) --- Create a new λ\" :cat :bytecode :internal :inline '(#$2F)) cat: :bytecode internal: #t inline: #t) #{##((#$2F))\n"
"1A0001\n"
"} $fn/dynamic (#nil) #@(documentation: \"(name args docs body) -> (μ) --- Create a new μ\" name: $macro/dynamic source: (\"(name args docs body) -> (μ) --- Create a new μ\" :cat :bytecode :internal :inline '(#$30)) cat: :bytecode internal: #t inline: #t) #{##((#$30))\n"
"1A0001\n"
"} $macro/dynamic (#nil) #@(documentation: \"(a b) -> (result)\" name: $add source: (\"(a b) -> (result)\" :cat :bytecode :internal :inline '(#$25)) cat: :bytecode internal: #t inline: #t) #{##((#$25))\n"
"1A0001\n"
"} $add (#nil) #@(documentation: \"(a b) -> (result)\" name: $sub source: (\"(a b) -> (result)\" :cat :bytecode :internal :inline '(#$26)) cat: :bytecode internal: #t inline: #t) #{##((#$26))\n"
"1A0001\n"
"} $sub (#nil) #@(documentation: \"(a b) -> (result)\" name: $mul source: (\"(a b) -> (result)\" :cat :bytecode :internal :inline '(#$27)) cat: :bytecode internal: #t inline: #t) #{##((#$27))\n"
"1A0001\n"
"} $mul (#nil) #@(documentation: \"(a b) -> (result)\" name: $div source: (\"(a b) -> (result)\" :cat :bytecode :internal :inline '(#$28)) cat: :bytecode internal: #t inline: #t) #{##((#$28))\n"
"1A0001\n"
"} $div (#nil) #@(documentation: \"(a b) -> (result)\" name: $rem source: (\"(a b) -> (result)\" :cat :bytecode :internal :inline '(#$29)) cat: :bytecode internal: #t inline: #t) #{##((#$29))\n"
"1A0001\n"
"} $rem (#nil) #@(documentation: \"() -> (#t)\" name: $push/true source: (\"() -> (#t)\" :cat :bytecode :internal :inline '(#$1B)) cat: :bytecode internal: #t inline: #t) #{##((#$1B))\n"
"1A0001\n"
"} $push/true (#nil) #@(documentation: \"() -> (#f)\" name: $push/false source: (\"() -> (#f)\" :cat :bytecode :internal :inline '(#$1C)) cat: :bytecode internal: #t inline: #t) #{##((#$1C))\n"
"1A0001\n"
"} $push/false (#nil) #@(documentation: \"(bc env) -> (return-val)\" name: $eval source: (\"(bc env) -> (return-val)\" :cat :bytecode :internal :inline '(#$1D)) cat: :bytecode internal: #t inline: #t) #{##((#$1D))\n"
"1A0001\n"
"} $eval (#nil) #@(documentation: \"(bc env) -> (return-val)\" name: $mutable-eval source: (\"(bc env) -> (return-val)\" :cat :bytecode :internal :inline '(#$2D)) cat: :bytecode internal: #t inline: #t) #{##((#$2D))\n"
"1A0001\n"
"} $mutable-eval (#nil) #@(documentation: \"(a) -> (result)\" name: $zero? source: (\"(a) -> (result)\" :cat :bytecode :internal :inline '(#$2A)) cat: :bytecode internal: #t inline: #t) #{##((#$2A))\n"
"1A0001\n"
"} $zero? (#nil) #@(documentation: \"(a) -> (result) --- Adds 1 to the topmost int\" name: $inc/int source: (\"(a) -> (result) --- Adds 1 to the topmost int\" :cat :bytecode :internal :inline '(#$23)) cat: :bytecode internal: #t inline: #t) #{##((#$23))\n"
"1A0001\n"
...
"} $push/int (a) #@(documentation: \"() -> (a) --- Push A on the stack as an :int that fits within a byte\" name: $push/int/byte cat: :bytecode internal: #t) #{##(int-fit-in-byte? a throw :invalid-bc-op \"$push/int/byte can only push a signed 8-bit value\" current-lambda #$2 int->bytecode-op)\n"
...
"070E0004012E0201\n"
"} $apply (count) #@(documentation: \"arguments -> (result) --- Read count arguments from the stack and put a list of those on the stack instead.\" name: $list cat: :bytecode internal: #t) #{##(count 255 throw :arity-error \"$list can only generate lists with up to 255 arguments in one go, try and use cons instead\" current-lambda #$2E int->bytecode-op)\n"
"0E001A01220B00160E021A031A040E000E0504002E040401090004240D1A060E\n"
"070E0004012E0201\n"
"} $list (target) #@(documentation: \"() -> () --- Try something, jumping to target if an exception occurs\" name: $try cat: :bytecode internal: #t) #{##(#$19 :relocate target int->bytecode-op)\n"
"1A001A010E02020802000E03020004012E051A010E02020002010E0302000401\n"
"2E052E0301\n"
"} $try (target) #@(name: $jmp cat: :bytecode internal: #t) #{##(#$9 :relocate target int->bytecode-op)\n"
"1A001A010E02020802000E03020004012E051A010E02020002010E0302000401\n"
"2E052E0301\n"
"} $jmp (v) #@(documentation: \"() -> (v) --- Pushes v onto the stack\" name: $push/val cat: :bytecode internal: #t) #{##(nil? v throw :invalid-bc-op \"Can't push #nil as a normal lVal\" current-lambda #$1A :literal)\n"
"0E000E0104010B00160E021A031A040E010E0504002E040401090004240D1A06\n"
"1A070E012E022E0201\n"
"} $push/val (v) #@(documentation: \"() -> (v) --- Resolve V and get the associated value on the stack\" name: $get/val cat: :bytecode internal: #t) #{##(:symbol type-of v throw :invalid-bc-op \"Can only get symbol\" current-lambda #$E :literal)\n"
"1A000E010E020401200B0007240900130E031A041A050E020E0604002E040401\n"
"0D1A071A080E022E022E0201\n"
"} $get/val (v) #@(documentation: \"(v) -> (v) --- Resolve V and get the associated value on the stack\" name: $set/val cat: :bytecode internal: #t) #{##(:symbol type-of v throw :invalid-bc-op \"Can only get symbol\" current-lambda #$5 :literal)\n"
"1A000E010E020401200B0007240900130E031A041A050E020E0604002E040401\n"
"0D1A071A080E022E022E0201\n"
"} $set/val (v) #@(documentation: \"(v) -> (v) --- Resolve V and get the associated value on the stack\" name: $def/val cat: :bytecode internal: #t) #{##(:symbol type-of v throw :invalid-bc-op \"Can only get symbol\" current-lambda #$7 :literal)\n"
"1A000E010E020401200B0007240900130E031A041A050E020E0604002E040401\n"
"0D1A071A080E022E022E0201\n"
"} $def/val (target) #@(name: $jt cat: :bytecode internal: #t) #{##(#$A :relocate target int->bytecode-op)\n"
"1A001A010E02020802000E03020004012E051A010E02020002010E0302000401\n"
"2E052E0301\n"
"} $jt (target) #@(name: $jf cat: :bytecode internal: #t) #{##(#$B :relocate target int->bytecode-op)\n"
"1A001A010E02020802000E03020004012E051A010E02020002010E0302000401\n"
"2E052E0301\n"
"} $jf (name args docs body) #@(name: $fn cat: :bytecode internal: #t) #{##(#$25 val->bytecode-op name args docs body)\n"
"1A000E010E0204010E010E0304010E010E0404010E010E0504012E0501\n"
"} $fn (name args docs body) #@(name: $macro* cat: :bytecode internal: #t) #{##(#$26 val->bytecode-op name args docs body)\n"
"1A000E010E0204010E010E0304010E010E0404010E010E0504012E0501\n"
"} $macro* (code sym-map pos) #@(name: assemble/build-sym-map) #{##(type-of code ΓεnΣym-67 :bytecode-op tree/set! sym-map :last-op pos :keyword ΓεnΣym-68 :label :literal :pair assemble/build-sym-map)\n"
...
"} assemble/build-sym-map (code sym-map pos out) #@(name: assemble/relocate-op) #{##(sym-map code target pos off array/set! out int->bytecode-op bit-and bit-shift-right 255)\n"
...
"} assemble/relocate-op (code sym-map pos out) #@(name: assemble/emit-relocated-ops) #{##(code :relocate assemble/relocate-op sym-map pos out ΓεnΣym-81 op type-of ΓεnΣym-82 :bytecode-op array/set! :pair assemble/emit-relocated-ops)\n"
...
"} assemble/emit-relocated-ops (i) #@(name: literal-index->bytecode-op) #{##(i 256 int->bytecode-op bit-and bit-shift-right 255)\n"
...
"} assemble/add-literal (code lit-arr) #@(name: assemble/build-lit-arr) #{##(code :pair type-of assemble/build-lit-arr lit-arr #$1A :literal assemble/add-literal index-op #$6 #$E #$F #$5 #$10 #$7 #$8 otherwise)\n"
...
"01\n"
"}#{##((source) #@(name: bytecompile/literal) #{##(type-of source ΓεnΣym-1 :int $push/int :nil (#$24) :bool (#$1B) (#$1C) :symbol $get/val :native-function :lambda #f bytecompile/literal closure/name $push/val)\n"
...
"} bytecompile/literal (source) #@(name: bytecompile/quote) #{##(type-of source ΓεnΣym-15 :nil (#$24) :int $push/int $push/val)\n"
"150E000E01040107020D0E021A03200B00081A0409001A0E021A05200B000C0E\n"
"060E0104010900090E070E0104011601\n"
"} bytecompile/quote (source env) #@(name: bytecompile/do/form) #{##(source bytecompile* env nil? (#$D) bytecompile/do/form)\n"
...
"} bytecompile/if (source env) #@(name: bytecompile/while) #{##(gensym sym-start sym-end (#$24) $jmp :label (#$D) bytecompile/do/form source env bytecompile* $jt)\n"
...
"01\n"
"} bytecompile/procedure/default (source env label-end) #@(name: bytecompile/and/rec) #{##(bytecompile* source env (#$C) $jf label-end (#$D) bytecompile/and/rec)\n"
...
"} bytecompile/and (source env label-end) #@(name: bytecompile/or/rec) #{##(source bytecompile* env (#$C) $jt label-end (#$D) bytecompile/or/rec)\n"
...
"} bytecompile/or (source env) #@(name: bytecompile/fn*) #{##(length source arg-count not= throw :arity-error \"(fn*) needs exactly 4 arguments\" current-lambda bytecompile* env (#$17))\n"
...
"} bytecompile/fn* (source env) #@(name: bytecompile/macro*) #{##(length source arg-count not= throw :arity-error \"(macro*) needs exactly 4 arguments\" current-lambda bytecompile* env (#$18))\n"
"0E000E0112040107020D0E030E02020504020B00160E041A051A060E010E0704\n"
"002E040401090004240D0E011205010D0E080E01110E0904020E080E012C0E09\n"
"04020E080E011212110E0904021A0A2E0401\n"
"} bytecompile/macro* (source env) #@(name: bytecompile/environment*) #{##((#$15) bytecompile/do/form source env (#$D) (#$13) (#$16))\n"
"1A000E010E02120E0304021A041A051A062E0501\n"
"} bytecompile/environment* (source env) #@(name: bytecompile/let*) #{##((#$15) bytecompile/do source env (#$16))\n"
...
"} bytecompile/return (source env) #@(name: bytecompile/try) #{##(gensym end-sym bytecompile* source env $try bytecompile/do/form (#$16) :label)\n"
...
"0E0019001D0E010E020E032B0E0202010E03252B0E0202020E03252B04031601\n"
"} bytecode-arr->sym (a b) #@(documentation: \"Turn two bytecode ops encoding an offset into the integer representation\" name: bytecode-op->offset) #{##(bit-or bit-shift-left bytecode-op->int a b t 32768 - 65536)\n"
...
"} macroexpand-fold (source env) #@(documentation: \"Expand all macros within source\" name: macroexpand* cat: :compiler internal: #t) #{##(resolves? source env resolve op type-of ΓεnΣym-21 :nil :macro macroexpand* macro-apply :native-function ΓεnΣym-22 quote do macroexpand-do return macroexpand-form try while #f def set! if fn* macro* let* environment* meta :fold macroexpand-fold map (α) #@(name: anonymous) #{##(macroexpand* α env)\n"
"0E000E010E02040201\n"
"} (α) #{##(macroexpand* α env)\n"
"0E000E010E02040201\n"
"})\n"
...
"} boolean (v) #@(documentation: \"Return true if V is false\" name: not source: (\"Return true if V is false\" :inline :cat :boolean-operations :related boolean (deftest #f (not #t)) (deftest #t (not #f)) (deftest #t (not (< 5 1))) (deftest #t (not (= #f #t))) (deftest #t (not (< 3 2))) (deftest #t (not (>= \"2\" 3))) (if v #f #t)) cat: :boolean-operations tests: ((#t (not (>= \"2\" 3))) (#t (not (< 3 2))) (#t (not (= #f #t))) (#t (not (< 5 1))) (#t (not #f)) (#f (not #t))) inline: #t related: (boolean)) #{##(v)\n"
...
"} when (key-sym cases) #@(name: case/clauses/multiple) #{##(cases = key-sym case/clauses/multiple)\n"
"0E000B00191A010E020E00112E030E030E020E00120402140900042401\n"
"} case/clauses/multiple (key-sym clauses) #@(name: case/clauses) #{##(clauses otherwise do if :pair type-of quote nil? :symbol = key-sym or case/clauses/multiple case/clauses)\n"
...
"} case body #@(documentation: \"Contains multiple cond clauses\" name: cond) #{##(body if do macro-apply cond)\n"
...
"14141401\n"
"} doseq (init fun) #@(name: thread/->) #{##(fun :pair type-of thread/-> init append)\n"
...
"1A181A191A1A18071B0D1A1C1A1D1A1E18071F0D1A201A211A221807230D151A\n"
"241A251A261707270D1A281A291A2A18072B16072B01\n"
...
"0E000E0112040101\n"
"} last? (a) #@(documentation: \"Return #t if a is positive\" name: pos? source: (:inline \"Return #t if a is positive\" (>= a 0.0)) inline: #t) #{##(a 0.0)\n"
"0E001A012101\n"
...
"1A5A17075B0D1A5C1A5D1A5E17075F0D1A601A611A621707630D1A641A651A66\n"
"1707670D1A681A691A6A17076B0D1A6C1A6D1A6E17076F0D1A701A711A721707\n"
"730D1A741A751A761707770D1A781A791A7A17077B01\n"
...
"1A230E0F1407200D020007240D1A251A261A271707280D0E140B00191A290E2A\n"
"0E2B0E140E2804020E2024140402140900050E2001\n"
