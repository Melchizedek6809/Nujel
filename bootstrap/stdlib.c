...
"} tree/filter (l f) #@(documentation: \"Return a new tree with all elements from L where F returns true\") #{##(tree/new ret tree/keys l ΓεnΣym-2 :pair type-of throw list :type-error \"Improper list detected, please provide a proper list instead\" current-lambda \"Expected a value of type :pair\" e t f tree/set!)\n"
"0E0024040107010D150E020E03040107040D240900790D1A050E060E04040120\n"
...
"0D0E0411070D0D0E030E0D2B070E0D0E0F0E0E04010B00100E100E010E0D0E0E\n"
"0403090004240D0E041205040E040AFF880D0E011601\n"
"} tree/merge (a b) #@(documentation: \"Merge two trees together, if a key is contained in both trees the on in B gets priority\") #{##(b a tree/dup tree/new ret tree/keys ΓεnΣym-3 :pair type-of throw list :type-error \"Improper list detected, please provide a proper list instead\" current-lambda \"Expected a value of type :pair\" k tree/set!)\n"
...
"060D240900670D1A070E080E060401200B0007240900190E090E0A1A0B1A0C0E\n"
"050E0004010E0D0400040404010D0E080E0604011A07200B0007240900150E09\n"
"0E0A1A0B1A0E0E060E0D0400040404010D0E0611070F0D0E100E040E0F0E000E\n"
"0F2B04030D0E061205060E060AFF9A0D0E041601\n"
"})\n"
"1A001A011A021A031707000D1A041A051A061A071707040D1A081A091A0A1A0B\n"
...
"} $apply/optimize? (fun arg-count) #@(cat: :bytecode internal: #t) #{##(fun ΓεnΣym-1 + - * / rem bytecode-eval* ref #f arg-count zero? car cdr add/int inc/int cons < <= = >= >)\n"
...
"100D0E010E08200C0A00060D1A090B000B0E0A02022009007B0E010E0B200C0A\n"
"006A0D0E010E0C200C0A00600D0E010E0D200C0A00560D0E010E0E200C0A004C\n"
"0D0E010E0F200C0A00420D0E010E10200C0A00380D0E010E11200C0A002E0D0E\n"
"010E12200C0A00240D0E010E13200C0A001A0D0E010E14200C0A00100D0E010E\n"
"15200C0A00060D1A090B00071B090004241601\n"
"} $apply/optimized (arg-count fun) #@(documentation: \"arguments -> (result) --- Read arg-count arguments from the stack, apply the to fun and push the result on the stack\" cat: :bytecode internal: #t) #{##(arg-count ΓεnΣym-2 fun ΓεnΣym-3 car (#$11) cdr (#$12) zero? (#$2A) inc/int (#$23) throw list :arity-error \"Wrong number of arguments for that function\" current-lambda ΓεnΣym-4 add/int (#$3) ref (#$2B) + (#$25) - (#$26) * (#$27) / (#$28) rem (#$29) cons (#$14) < (#$1E) <= (#$1F) = (#$20) >= (#$21) > (#$22) bytecode-eval* (#$1D))\n"
...
"0B00081A0B0900150E0C0E0D1A0E1A0F0E020E10040004040401160900EF0E01\n"
"0202200B00D5150E0207110D0E110E12200B00081A130900BE0E110E14200B00\n"
"081A150900B10E110E16200B00081A170900A40E110E18200B00081A19090097\n"
"0E110E1A200B00081A1B09008A0E110E1C200B00081A1D09007D0E110E1E200B\n"
"00081A1F0900700E110E20200B00081A210900630E110E22200B00081A230900\n"
"560E110E24200B00081A250900490E110E26200B00081A2709003C0E110E2820\n"
"0B00081A2909002F0E110E2A200B00081A2B0900220E110E2C200B00081A2D09\n"
"00150E0C0E0D1A0E1A0F0E020E10040004040401160900150E0C0E0D1A0E1A0F\n"
"0E020E100400040404011601\n"
...
"0E000E0112112B07020D0E020E0112121211250E032607040D0E050E060E0302\n"
"012505030E070E080E090E040E0112121104021A0A0402040104030D0E030101\n"
...
"1707880D1A8C1A8D1A8A1A8E17078C0D1A8F1A901A911A9217078F0D1A931A94\n"
"1A861A951707930D1A961A971A981A991707960D0E96079A0D1A9B1A9C1A9D1A\n"
"9E17079B0D1A9F1AA01AA11AA217079F0D1AA31AA41AA11AA51707A30D1AA61A\n"
"A71A861AA81707A60D1AA91AAA1A861AAB1707A90D1AAC1AAD1A861AAE1707AC\n"
"0D1AAF1AB01A861AB11707AF0D151AB21AB31A7A1AB41707B20D1AB51AB61A7A\n"
"1AB71707B50D1AB81AB91A7A1ABA1707B80D1ABB1ABC1A7A1ABD1707BB0D0200\n"
"07BE0D1ABF1AC01A7A1AC11707BF0D1AC21AC31A7A1AC41707C20D1AC51AC61A\n"
"7A1AC71707C50D1AC81AC91ACA1ACB1707C81607C80D1ACC1ACD1ACA1ACE1707\n"
"CC0D1ACF1AD01AD11AD21807CF01\n"
...
"} disassemble/op (a i literals) #@(documentation: \"Disassemble a single bytecode op in A at I and return it as an s-expression, that could be applied to eval\") #{##(a i ΓεnΣym-2 #$0 ($nop) #$1 ($ret) #$2 $push/int/byte bytecode-op->int #$3 ($add/int) #$4 $apply #$5 $set/val disassemble/maybe-quote literals #$6 $push/val/ext bit-or bit-shift-left #$7 $def/val #$8 $def/val/ext #$9 $jmp* bytecode-arr->offset #$A $jt* #$B $jf* #$C ($dup) #$D ($drop) #$E $get/val #$F $get/val/ext #$10 $set/val/ext #$11 ($car) #$12 ($cdr) #$13 ($closure/push) #$14 ($cons) #$15 ($let) #$16 ($closure/pop) #$17 ($fn/dynamic) #$18 ($macro/dynamic) #$19 $try #$1A $push/val #$1B ($push/true) #$1C ($push/false) #$1D ($eval) #$1E ($<) #$1F ($<=) #$20 ($=) #$21 ($>=) #$22 ($>) #$23 ($inc/int) #$24 ($push/nil) #$25 ($add) #$26 ($sub) #$27 ($mul) #$28 ($div) #$29 ($rem) #$2A ($zero?) #$2B ($ref) :unknown-op)\n"
"150E000E012B07020D0E021A03200B00081A040903820E021A05200B00081A06\n"
"0903750E021A07200B00171A080E090E000E010201252B04012414140903590E\n"
"021A0A200B00081A0B09034C0E021A0C200B00171A0D0E090E000E010201252B\n"
"04012414140903300E021A0E200B001E1A0F0E100E110E090E000E010201252B\n"
"04012B040124141409030D0E021A12200B00301A130E110E140E090E000E0102\n"
"01252B04010E150E090E000E010202252B04010208040204022B2414140902D8\n"
"0E021A16200B001E1A170E100E110E090E000E010201252B04012B0401241414\n"
"0902B50E021A18200B00301A190E110E140E090E000E010201252B04010E150E\n"
"090E000E010202252B04010208040204022B2414140902800E021A1A200B0016\n"
"1A1B0E1C0E000E0102012504022414140902650E021A1D200B00161A1E0E1C0E\n"
"000E01020125040224141409024A0E021A1F200B00161A200E1C0E000E010201\n"
"25040224141409022F0E021A21200B00081A220902220E021A23200B00081A24\n"
"0902150E021A25200B001E1A260E100E110E090E000E010201252B04012B0401\n"
"2414140901F20E021A27200B00301A280E110E140E090E000E010201252B0401\n"
"0E150E090E000E010202252B04010208040204022B2414140901BD0E021A2920\n"
"0B00301A2A0E110E140E090E000E010201252B04010E150E090E000E01020225\n"
"2B04010208040204022B2414140901880E021A2B200B00081A2C09017B0E021A\n"
"2D200B00081A2E09016E0E021A2F200B00081A300901610E021A31200B00081A\n"
"320901540E021A33200B00081A340901470E021A35200B00081A3609013A0E02\n"
"1A37200B00081A3809012D0E021A39200B00081A3A0901200E021A3B200B0016\n"
