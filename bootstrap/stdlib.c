...
"2E042F1601\n"
"} reduce (α) #@(documentation: \"Returns the length of collection α\" name: length) #{##(:length α)\n"
"1A000E01040101\n"
"} length (l f) #@(documentation: \"Runs f over every item in collection l and returns the resulting list\" name: map) #{##(type-of l ΓεnΣym-19 :nil :pair list/map f :array array/map :type-error \"You can only use map with a collection\" current-lambda)\n"
...
"} map (l) #@(documentation: \"Sorts the collection L\" name: sort) #{##(type-of l ΓεnΣym-26 :nil :pair list/sort :array array/sort :type-error \"You can only use sort with a collection\" current-lambda)\n"
...
"04002E042F1601\n"
"} sort (l start end) #@(documentation: \"Return a subcollection of L from START to END\" name: cut) #{##(type-of l ΓεnΣym-33 :pair list/cut start end :array array/cut :string string/cut :type-error \"You can only use member with a collection\" current-lambda)\n"
...
"151A000E0112040107020D0E020202200B003E1A030E040E012C0401200B0007\n"
...
"} whitespace? l #@(documentation: \"Turn the provided char codes into a string and return it\" name: from-char-code) #{##(buffer/allocate :length l buf i :int type-of 255 #f :type-error \"(from-char-code) expects :int arguments from 0 to 255, not: \" current-lambda buffer->string)\n"
"0E001A010E020401040107030D020007040D2409005D0D1A050E060E02110401\n"
...
"100E111A0D0E12040104011C040207130D0E141A151A0D0E130401040207160D\n"
"150E0607170D2409005C0D0E171107180D0E190E020E18120201250E0F040307\n"
"1A0D1A1B0E1A200B00072409000A0E1A0E0E14050E0D0E1C0E190E0202010E18\n"
"11250E181204030E130E160403071D0D0E1D0E0E14050E0D0E1811050F0D0E17\n"
"1205170E170AFFA50D24160D0E0F0200220B001A0E190E0202000E0F0403071A\n"
"0D0E1A0E0E14050E090004240D020007070D2409002A0D0E130E072B0B000724\n"
"0900171A0A1A1E0E020E120E072B2E020E0504002E042F0D0E072305070E071A\n"
"0D0E1304011E0AFFD00D240D0E0E120B000B1A1F0E0E1409001B1A000E010E0E\n"
"110401200B00090E0E110900081A200E0E14071D0D020007210D1A221A231A24\n"
"1707250D0E120B00191A260E270E280E120E2504020E1D24140402140900050E\n"
"1D01\n"
