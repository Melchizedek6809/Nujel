...
"1A0001\n"
"} $inc/int (#nil) #@(documentation: \"(a b) -> (result)\" name: $bit-shift-left source: (\"(a b) -> (result)\" :cat :bytecode :internal :inline '(49)) cat: :bytecode internal: #t inline: #t) #{##((49))\n"
"1A0001\n"
"} $bit-shift-left (#nil) #@(documentation: \"(a b) -> (result)\" name: $bit-shift-right source: (\"(a b) -> (result)\" :cat :bytecode :internal :inline '(50)) cat: :bytecode internal: #t inline: #t) #{##((50))\n"
"1A0001\n"
"} $bit-shift-right (#nil) #@(documentation: \"(a b) -> (result)\" name: $bit-and source: (\"(a b) -> (result)\" :cat :bytecode :internal :inline '(51)) cat: :bytecode internal: #t inline: #t) #{##((51))\n"
"1A0001\n"
"} $bit-and (#nil) #@(documentation: \"(a b) -> (result)\" name: $bit-or source: (\"(a b) -> (result)\" :cat :bytecode :internal :inline '(52)) cat: :bytecode internal: #t inline: #t) #{##((52))\n"
"1A0001\n"
"} $bit-or (#nil) #@(documentation: \"(a b) -> (result)\" name: $bit-xor source: (\"(a b) -> (result)\" :cat :bytecode :internal :inline '(53)) cat: :bytecode internal: #t inline: #t) #{##((53))\n"
"1A0001\n"
"} $bit-xor (#nil) #@(documentation: \"(a) -> (result)\" name: $bit-not source: (\"(a) -> (result)\" :cat :bytecode :internal :inline '(54)) cat: :bytecode internal: #t inline: #t) #{##((54))\n"
"1A0001\n"
...
"} $macro* (code sym-map pos) #@(name: assemble/build-sym-map) #{##(type-of code ΓεnΣym-81 :int tree/set! sym-map :last-op pos :keyword ΓεnΣym-82 :label :relocate :literal :pair assemble/build-sym-map)\n"
...
"} assemble/build-sym-map (code sym-map pos out) #@(name: assemble/relocate-op) #{##(sym-map code target pos off array/set! out 255)\n"
"0E000E012C2B07020D0E020E0112121211250E032607040D0E050E060E030201\n"
"2505030E040E01121211321A073304030D0E030101\n"
"} assemble/relocate-op (code sym-map pos out) #@(name: assemble/emit-relocated-ops) #{##(code :relocate assemble/relocate-op sym-map pos out ΓεnΣym-97 op type-of ΓεnΣym-98 :int array/set! :pair assemble/emit-relocated-ops)\n"
...
"1707E70D151AE81AE91AEA1707EB0D1AEC1AED1AEE1707EF0D1AF01AF11AF217\n"
"07F30D1AF41AF51AF61707F70D020007F80D1AF91AFA1AFB1707FC0D1AFD1AFE\n"
"1AFF170801000D060101060102060103170801040D0601050601060601071708\n"
"0108160801080D06010906010A06010B1708010C0D06010D06010E06010F1808\n"
"011001\n"
...
"150E0007010D0E010200200C0A01960D0E010201200C0A018C0D0E010203200C\n"
"0A01820D0E01020C200C0A01780D0E01020D200C0A016E0D0E010211200C0A01\n"
"640D0E010212200C0A015A0D0E010213200C0A01500D0E010214200C0A01460D\n"
"0E010215200C0A013C0D0E010216200C0A01320D0E010217200C0A01280D0E01\n"
"0218200C0A011E0D0E010219200C0A01140D0E01021B200C0A010A0D0E01021C\n"
"200C0A01000D0E01021D200C0A00F60D0E01021E200C0A00EC0D0E01021F200C\n"
"0A00E20D0E010220200C0A00D80D0E010221200C0A00CE0D0E010222200C0A00\n"
"C40D0E010223200C0A00BA0D0E010224200C0A00B00D0E010225200C0A00A60D\n"
"0E010226200C0A009C0D0E010227200C0A00920D0E010228200C0A00880D0E01\n"
"0229200C0A007E0D0E01022A200C0A00740D0E01022B200C0A006A0D0E01022C\n"
"200C0A00600D0E01022D200C0A00560D0E01022F200C0A004C0D0E010230200C\n"
"0A00420D0E010231200C0A00380D0E010232200C0A002E0D0E010233200C0A00\n"
