...
"2E042F1601\n"
"} reduce (α) #@(documentation: \"Returns the length of collection α\" name: length) #{##(type-of α ΓεnΣym-19 :pair list/length :tree tree/size :length)\n"
"150E000E01040107020D0E021A03200B000C0E040E01040109001A0E021A0520\n"
"0B000C0E060E0104010900091A070E0104011601\n"
"} length (l f) #@(documentation: \"Runs f over every item in collection l and returns the resulting list\" name: map) #{##(type-of l ΓεnΣym-24 :nil :pair list/map f :array array/map :type-error \"You can only use map with a collection\" current-lambda)\n"
...
"} map (l) #@(documentation: \"Sorts the collection L\" name: sort) #{##(type-of l ΓεnΣym-31 :nil :pair list/sort :array array/sort :type-error \"You can only use sort with a collection\" current-lambda)\n"
...
"04002E042F1601\n"
"} sort (l start end) #@(documentation: \"Return a subcollection of L from START to END\" name: cut) #{##(type-of l ΓεnΣym-38 :pair list/cut start end :array array/cut :string string/cut :type-error \"You can only use member with a collection\" current-lambda)\n"
...
"110E011401\n"
"} assemble/flatten (code) #@(documentation: \"Assemble all arguments into a single :bytecode-array\" name: assemble* cat: :bytecode internal: #t) #{##(tree/new sym-map array/new lit-arr assemble/build-lit-arr assemble/flatten code tmp assemble/build-sym-map array/allocate :last-op out assemble/emit-relocated-ops :bytecode-array)\n"
...
"} whitespace? l #@(documentation: \"Turn the provided char codes into a string and return it\" name: from-char-code) #{##(buffer/allocate list/length l buf i :int type-of 255 #f :type-error \"(from-char-code) expects :int arguments from 0 to 255, not: \" current-lambda :length buffer->string)\n"
...
"0E0211370D0E021205020D0E042305040E041A0C0E0304011E0AFF9D0D0E0D0E\n"
"03040101\n"
"} from-char-code)\n"
"1A001A011A021707030D1A041A051A061707070D1A081A091A0A17070B0D1A0C\n"
"1A0D1A0E17070F01\n"
...
"} fmt/find-non-digit-from-right (opts spec) #@(name: fmt/parse-spec) #{##(:length spec opts ΓεnΣym-6 #f fmt/find-non-digit-from-right next-non-digit string/cut number :width read/single :padding-char \"0\" fmt/parse-spec :debug :base :HEXADECIMAL :hexadecimal :decimal :octal :binary :align :left :center :right :precision :format-error \"Unknown form-spec option\" current-closure)\n"
...
"00060D1A040B00620E050E011A000E010401020126040207060D0E070E010201\n"
...
"040304020901980E03023F200B00210E0D0E021A0E1B370E070E0102001A000E\n"
...
"1A0F1A11370E070E0102001A000E010401020126040304020901240E03026420\n"
"0B00220E0D0E021A0F1A12370E070E0102001A000E0104010201260403040209\n"
"00FD0E03026F200B00220E0D0E021A0F1A13370E070E0102001A000E01040102\n"
...
"370E070E0102001A000E010401020126040304020900880E03025E200B00220E\n"
"0D0E021A151A17370E070E0102001A000E010401020126040304020900610E03\n"
"023E200B00220E0D0E021A151A18370E070E0102001A000E0104010201260403\n"
"040209003A0E03022E200B00250E0D0E021A190E021A092B370E070E0102001A\n"
...
"072305070E071A0D0E0204011E0AFF7E0D240D1A090E010E06110401200B0013\n"
"1A0A1A0B0E020E0504002E042F090004240D24070E0D1A0D0E020401070F0D0E\n"
"100E110E120E13040104011C040207140D0E151A161A0D0E140401040207170D\n"
"150E0607180D2409005C0D0E181107190D0E1A0E020E19120201250E0F040307\n"
"1B0D1A1C0E1B200B00072409000A0E1B0E0E14050E0D0E1D0E1A0E0202010E19\n"
"11250E191204030E140E170403071E0D0E1E0E0E14050E0D0E1911050F0D0E18\n"
"1205180E180AFFA50D24160D0E0F0200220B001A0E1A0E0202000E0F0403071B\n"
"0D0E1B0E0E14050E090004240D020007070D2409002A0D0E140E072B0B000724\n"
"0900171A0A1A1F0E020E130E072B2E020E0504002E042F0D0E072305070E071A\n"
"0D0E1404011E0AFFD00D240D0E0E120B000B1A200E0E1409001B1A000E010E0E\n"
"110401200B00090E0E110900081A210E0E14071E0D020007220D1A231A241A25\n"
"1707260D0E130B00191A270E280E290E130E2604020E1E24140402140900050E\n"
"1E01\n"
...
"} path/ext?! (path) #@(documentation: \"Return the extension of PATH\" name: path/extension) #{##(last-index-of path \".\" last-period string/cut :length)\n"
"0E000E011A02040207030D0E030200210B00170E040E0102010E03251A050E01\n"
...
"} write/raw/array (v port hr?) #@(name: write/raw/buffer) #{##(hr? port write \"#<buffer :id \" int->string/decimal val->id v \" :size \" int->string/hex :length \">\" block-write \"#m\" buffer/u8* view i pad-start int->string/HEX \"0\")\n"
...
"2504030900050E0101\n"
"} string/round (str separator) #@(name: split/empty) #{##(:length str slen start ret string/cut reverse)\n"
"1A000E01040107020D020007030D2407040D2409001E0D0E050E010E0302010E\n"
"032504030E041405040D0E0302012505030E030E021E0AFFE00D0E060E040401\n"
"01\n"
"} split/empty (str separator start) #@(name: split/string) #{##(start index-of str separator pos-found string/cut split/string :length)\n"
"0E000B000724090007020005000D0E010E020E030E00040307040D0E04020021\n"
"0B00220E050E020E000E0404030E060E020E030E041A070E0304012504031409\n"
"00130E050E020E001A070E0204010403241401\n"
"} split/string (str separator) #@(documentation: \"Splits STR into a list at every occurunse of SEPARATOR\" name: split) #{##(type-of str :string :type-error \"Expected a value of type :string\" current-lambda separator :length ΓεnΣym-55 split/empty split/string)\n"
"0E000E0104011A02200B0007240900101A031A040E010E0504002E042F0D0E00\n"
