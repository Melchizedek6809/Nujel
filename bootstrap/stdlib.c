...
"01\n"
"})) (deftest #f (bytecode-array? (:u8 #m00))) (deftest #f (bytecode-array? #m00)) (deftest #f (bytecode-array? \"asd\")) (deftest #f (bytecode-array? (array/new #nil))) :inline (= :bytecode-array (:type-name v))) cat: :type-predicate tests: ((#f (bytecode-array? (array/new #nil))) (#f (bytecode-array? \"asd\")) (#f (bytecode-array? #m00)) (#f (bytecode-array? (:u8 #m00))) (#t (bytecode-array? #{##()\n"
"01\n"
...
"0E001A010E021A030401040201\n"
"}#{##(module/insert/defer :random string/write (do (def *module* :random) (def seed 0) (defclass rng \"A simple RNG\" :export (defn seed! (self seed) \"Set a new seed value for the RNG\" (set! self :seed seed)) (defn rng! (self) \"Generate a random integer\" (set! self :seed (+ 12345 (* (ref self :seed) 1103515245))) (bit-or (bit-shift-left (bit-and (ref self :seed) 65535) 16) (bit-and (bit-shift-right (ref self :seed) 16) 65535))) (defn int (self max) \"Return a value from 0 to MAX, or, if left out, a random int\" (if max (rem (abs (:rng! self)) max) (:rng! self)))) (defn new (seed) :export (tree/new :seed (or seed (bit-xor (time) (time/milliseconds))) :prototype* rng)) (defn rng! (#nil) :export (set! seed (+ 12345 (* seed 1103515245))) (bit-or (bit-shift-left (bit-and seed 65535) 16) (bit-and (bit-shift-right seed 16) 65535))) (defn seed! (new-seed) :export \"Set a new seed value for the RNG\" (set! seed new-seed)) (defn seed (#nil) :export \"Return the current RNG seed value\" (return seed)) (defn random (max) :export-as int \"Return a value from 0 to MAX, or, if left out, a random int\" (if max (rem (abs (rng!)) max) (rng!))) (defn seed-initialize! (#nil) :export (set! seed (bit-xor (time) (time/milliseconds)))) (seed-initialize!) (deftest #t (int? (random/int))) (deftest #t (random/seed! 123) (def first-value (random/int)) (random/seed! 123) (= first-value (random/int))) (deftest #t (random/seed! 99) (not= (random/int) (random/int))) (deftest #t (int? (-> (random/new) :int))) (deftest #t (def rng (random/new 123)) (def a (:int rng)) (:seed! rng 123) (= (:int rng) a)) (deftest #t (def rng (random/new 99)) (not= (:int rng) (:int rng)))))\n"
"0E001A010E021A030401040201\n"
