...
"} array/fill! (a b) #@(documentation: \"Append array A to array B\" name: array/append) #{##(:array type-of a b :type-error \"array/append expects two arrays as its arguments\" current-lambda array/allocate :length ret i rl)\n"
"1A000E010E020401200C0B000D0D1A000E010E030401200B00072409000F1A04\n"
"1A05240E0604002E042F0D0E071A080E0204011A080E03040125040107090D02\n"
"00070A0D240900140D0E090E0A0E020E0A2B370D0E0A23050A0E0A1A080E0204\n"
"011E0AFFE60D240D151A080E020401070A0D1A080E090401070B0D2409001D0D\n"
"0E090E0A0E030E0A1A080E020401262B370D0E0A020103050A0E0A0E0B1E0AFF\n"
"E1160D0E090101\n"
"} array/append (a) #@(documentation: \"Duplicate Array A\" name: array/dup) #{##(array/allocate :length a ret i)\n"
"0E001A010E020401040107030D020007040D240900140D0E030E040E020E042B\n"
"370D0E042305040E041A010E0204011E0AFFE60D0E0301\n"
...
"} array/map (arr pred) #@(documentation: \"Filter an array, (filter) should be preferred\" name: array/filter) #{##(ri :length arr len array/allocate ret ai pred :length!)\n"
"020007000D1A010E02040107030D0E040E03040107050D020007060D2409002C\n"
"0D0E070E020E062B04010B00180E050E000E020E062B370D0E00020125050009\n"
"0004240D0E062305060E060E031E0AFFD20D1A080E050E00040201\n"
"} array/filter (a b) #@(name: array/equal?) #{##(:array type-of a b not= :length #f i equal?)\n"
...
"} array/heap-sort array/sort (arr start end) #@(documentation: \"Return a newly allocated array with the values of ARR from START to END\" name: array/cut) #{##(max start min :length arr end array/allocate ret i)\n"
"0E0002000E01040205010D0E021A030E0404010E05040205050D0E060E000200\n"
...
"2E042F1601\n"
"} reduce (α) #@(documentation: \"Returns the length of collection α\" name: length) #{##(type-of α ΓεnΣym-19 :nil :pair list/length :array :length :tree tree/size :buffer :string :buffer-view #f buffer/length :type-error \"You can only use length with a collection\" current-lambda)\n"
"150E000E01040107020D0E021A03200B0008020009006F0E021A04200B000C0E\n"
"050E01040109005E0E021A06200B000C1A070E01040109004D0E021A08200B00\n"
...
"} literal-index->bytecode-op *max-literal-arr* (lit lit-arr) #@(name: assemble/add-literal) #{##(:length lit-arr 65535 :out-of-bounds \"Can only store up to 255 literals per bytecode-arr\" code current-lambda not= type-of lit :pair i equal? literal-index->bytecode-op :length!)\n"
...
"100E110E120E13040104011C040207140D0E151A161A170E140401040207180D\n"
...
"0900171A0A1A200E020E130E072B2E020E0504002E042F0D0E072305070E071A\n"
