...
"2E052E0301\n"
"} $jmp (target) #@(cat: :bytecode internal: #t) #{##(#$9 :relocate target int->bytecode-op)\n"
"1A001A010E02020802000E03020004012E051A010E02020002010E0302000401\n"
"2E052E0301\n"
...
"1A000E010E0204010E010E0304010E010E0404010E010E0504012E0501\n"
"} assemble/build-sym-map (code sym-map pos) #{##(type-of code ΓεnΣym-67 :bytecode-op tree/set! sym-map :last-op pos :keyword ΓεnΣym-68 :label :literal :pair assemble/build-sym-map)\n"
...
"} assemble/emit-relocated-ops (code sym-map pos out) #{##(code :relocate assemble/relocate-op sym-map pos out ΓεnΣym-81 op type-of ΓεnΣym-82 :bytecode-op array/set! :pair assemble/emit-relocated-ops)\n"
...
"1A951A961707930D1A971A981A991A9A1707970D1A9B1A9C1A9D1A9E17079B0D\n"
"1A9F1AA01AA11AA217079F0D1AA31AA41AA51AA61707A30D1AA71AA81AA91AAA\n"
"1707A70D1AAB1AAC1AA91AAD1707AB0D1AAE1AAF1A9D1AB01707AE0D1AB11AB2\n"
"1A9D1AB31707B10D1AB41AB51A9D1AB61707B40D1AB71AB81A9D1AB91707B70D\n"
"151ABA1ABB1A821ABC1707BA0D1ABD1ABE1A821ABF1707BD0D1AC01AC11A821A\n"
"C21707C00D1AC31AC41A821AC51707C30D020007C60D1AC71AC81A821AC91707\n"
"C70D1ACA1ACB1A821ACC1707CA0D1ACD1ACE1A821ACF1707CD0D1AD01AD11AD2\n"
"1AD31707D01607D00D1AD41AD51AD21AD61707D40D1AD71AD81AD91ADA1807D7\n"
"01\n"
...
"040401\n"
"} bytecompile/procedure/default (op args env op-raw) #{##(procedure? op :symbol type-of :pair throw :type-error \"Can't apply to that\" current-lambda length args arg-count $apply/optimized optimized bytecompile/procedure/arg bytecompile* op-raw env $apply)\n"
