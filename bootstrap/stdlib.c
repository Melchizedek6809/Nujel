...
"} $apply/optimize? (fun arg-count) #@(cat: :bytecode internal: #t) #{##(fun ΓεnΣym-6 + - * / rem bytecode-eval* #f arg-count zero? car cdr cadr add/int inc/int ref cons < <= = >= >)\n"
...
"0E001A010E020E0304010E020E0404010E020E0504010E020E060401040501\n"
"} assemble/build-sym-map (code sym-map pos) #{##(type-of code ΓεnΣym-68 :bytecode-op tree/set! sym-map :last-op pos :keyword ΓεnΣym-69 :label :literal :pair assemble/build-sym-map)\n"
...
"} assemble/emit-relocated-ops (code sym-map pos out) #{##(code :relocate assemble/relocate-op sym-map pos out ΓεnΣym-82 op type-of ΓεnΣym-83 :bytecode-op array/set! :pair assemble/emit-relocated-ops)\n"
...
"0E000E01040101\n"
"} disassemble (bc) #@(documentation: \"Disassemble the bytecode array CODE, turning it into a list of dotted pairs, with the car containing the offset and the cdr containing assembler S-Expressions,\" cat: :bytecode internal: #t) #{##(type-of bc ΓεnΣym-116 :lambda :macro #f disassemble/to-string closure/code :bytecode-array throw list :type-error \"Can't disassemble that\" current-lambda)\n"
