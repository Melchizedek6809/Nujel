...
"01\n"
"} $apply (count) #@(documentation: \"arguments -> (result) --- Read count arguments from the stack and put a list of those on the stack instead.\" name: $list cat: :bytecode internal: #t) #{##(count 255 :arity-error \"$list can only generate lists with up to 255 arguments in one go, try and use cons instead\" current-lambda)\n"
...
"1AC01AC11AC21707C30D1AC41AC51AC61707C70D1AC81AC91ACA1707CB0D151A\n"
"CC1ACD1ACE1707CF0D1AD01AD11AD21707D30D1AD41AD51AD61707D70D1AD81A\n"
"D91ADA1707DB0D020007DC0D1ADD1ADE1ADF1707E00D1AE11AE21AE31707E40D\n"
"1AE51AE61AE71707E80D1AE91AEA1AEB1707EC1607EC0D1AED1AEE1AEF1707F0\n"
"0D1AF11AF21AF31807F401\n"
...
"} bytecompile/try (source env) #@(documentation: \"Compile the forms in source\" name: bytecompile* cat: :bytecode internal: #t) #{##(resolves? source env resolve op type-of ΓεnΣym-69 :lambda :native-function :pair :symbol #f ΓεnΣym-70 do bytecompile/do let* bytecompile/let* def bytecompile/def set! bytecompile/set! if bytecompile/if while bytecompile/while and bytecompile/and or bytecompile/or fn* bytecompile/fn* macro* bytecompile/macro* environment* bytecompile/environment* try bytecompile/try return bytecompile/return quote bytecompile/quote bytecompile/procedure :type-error \"Can't evaluate that\" current-lambda bytecompile/literal)\n"
...
"010900110E290E040E01120E020E01110404160900251A090E050E010401200B\n"
"00131A2A1A2B0E010E2C04002E042F0900090E2D0E0104011601\n"
...
"150E0007010D0E010200200C0A01500D0E010201200C0A01460D0E010203200C\n"
"0A013C0D0E01020C200C0A01320D0E01020D200C0A01280D0E010211200C0A01\n"
"1E0D0E010212200C0A01140D0E010213200C0A010A0D0E010214200C0A01000D\n"
"0E010215200C0A00F60D0E010216200C0A00EC0D0E010217200C0A00E20D0E01\n"
"0218200C0A00D80D0E010219200C0A00CE0D0E01021B200C0A00C40D0E01021C\n"
"200C0A00BA0D0E01021D200C0A00B00D0E01021E200C0A00A60D0E01021F200C\n"
"0A009C0D0E010220200C0A00920D0E010221200C0A00880D0E010222200C0A00\n"
"7E0D0E010223200C0A00740D0E010224200C0A006A0D0E010225200C0A00600D\n"
"0E010226200C0A00560D0E010227200C0A004C0D0E010228200C0A00420D0E01\n"
"0229200C0A00380D0E01022A200C0A002E0D0E01022B200C0A00240D0E01022C\n"
"200C0A001A0D0E01022D200C0A00100D0E01022F200C0A00060D1A020B000802\n"
"010900B00E010202200C0A00420D0E010204200C0A00380D0E010205200C0A00\n"
"2E0D0E010207200C0A00240D0E01020E200C0A001A0D0E01021A200C0A00100D\n"
"0E01022E200C0A00060D1A020B000802020900600E010206200C0A00420D0E01\n"
"0208200C0A00380D0E010209200C0A002E0D0E01020A200C0A00240D0E01020B\n"
"200C0A001A0D0E01020F200C0A00100D0E010210200C0A00060D1A020B000802\n"
"030900101A031A040E000E0504002E042F1601\n"
...
"} disassemble/maybe-quote (a i literals) #@(documentation: \"Disassemble a single bytecode op in A at I and return it as an s-expression, that could be applied to eval\" name: disassemble/op) #{##(a i ΓεnΣym-23 ($nop) ($ret) $push/int/byte ($add/int) $apply $set/val disassemble/maybe-quote literals $push/val/ext bit-or bit-shift-left $def/val $def/val/ext $jmp* bytecode-arr->offset $jt* $jf* ($dup) ($drop) $get/val $get/val/ext $set/val/ext ($car) ($cdr) ($closure/push) ($cons) ($let) ($closure/pop) ($fn/dynamic) ($macro/dynamic) $try $push/val ($push/true) ($push/false) ($eval) ($<) ($<=) ($=) ($>=) ($>) ($inc/int) ($push/nil) ($add) ($sub) ($mul) ($div) ($rem) ($zero?) ($ref) ($cadr) ($mutable-eval) $list ($throw) :unknown-op)\n"
"150E000E012B07020D0E020200200B00081A0309038D0E020201200B00081A04\n"
"0903800E020202200B00131A050E000E010201252B2414140903680E02020320\n"
"0B00081A0609035B0E020204200B00131A070E000E010201252B241414090343\n"
"0E020205200B001A1A080E090E0A0E000E010201252B2B04012414140903240E\n"
"020206200B002C1A0B0E0A0E0C0E0C0E000E010201252B0E0D0E000E01020225\n"
"2B04010402020804022B2414140902F30E020207200B001A1A0E0E090E0A0E00\n"
"0E010201252B2B04012414140902D40E020208200B00281A0F0E0A0E0C0E000E\n"
"010201252B0E0D0E000E010202252B0208040204022B2414140902A70E020209\n"
"200B00161A100E110E000E01020125040224141409028C0E02020A200B00161A\n"
"120E110E000E0102012504022414140902710E02020B200B00161A130E110E00\n"
"0E0102012504022414140902560E02020C200B00081A140902490E02020D200B\n"
"00081A1509023C0E02020E200B001A1A160E090E0A0E000E010201252B2B0401\n"
"24141409021D0E02020F200B00281A170E0A0E0C0E000E010201252B0E0D0E00\n"
"0E010202252B0208040204022B2414140901F00E020210200B00281A180E0A0E\n"
"0C0E000E010201252B0E0D0E000E010202252B0208040204022B2414140901C3\n"
"0E020211200B00081A190901B60E020212200B00081A1A0901A90E020213200B\n"
"00081A1B09019C0E020214200B00081A1C09018F0E020215200B00081A1D0901\n"
"820E020216200B00081A1E0901750E020217200B00081A1F0901680E02021820\n"
"0B00081A2009015B0E020219200B00161A210E110E000E010201250402241414\n"
"0901400E02021A200B001A1A220E090E0A0E000E010201252B2B040124141409\n"
"01210E02021B200B00081A230901140E02021C200B00081A240901070E02021D\n"
"200B00081A250900FA0E02021E200B00081A260900ED0E02021F200B00081A27\n"
"0900E00E020220200B00081A280900D30E020221200B00081A290900C60E0202\n"
"22200B00081A2A0900B90E020223200B00081A2B0900AC0E020224200B00081A\n"
"2C09009F0E020225200B00081A2D0900920E020226200B00081A2E0900850E02\n"
"0227200B00081A2F0900780E020228200B00081A3009006B0E020229200B0008\n"
"1A3109005E0E02022A200B00081A320900510E02022B200B00081A330900440E\n"
"02022C200B00081A340900370E02022D200B00081A3509002A0E02022E200B00\n"
"131A360E000E010201252B2414140900120E02022F200B00081A370900051A38\n"
"1601\n"
