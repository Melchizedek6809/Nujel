...
"040401\n"
"} bytecompile/procedure (op args env op-raw) #@(name: bytecompile/procedure/default) #{##(procedure? op :symbol type-of :pair :keyword :type-error \"Can't apply to that\" current-lambda length args arg-count $apply/optimized optimized bytecompile/procedure/arg bytecompile* op-raw env $apply)\n"
"0E000E0104010B00071C0900041B0C0B00410D1A020E030E010401200B00071C\n"
"0900041B0C0B002B0D1A040E030E010401200B00071C0900041B0C0B00150D1A\n"
"050E030E010401200B00071C0900041B0B00131A061A070E010E0804002E042F\n"
"090004240D0E090E0A0401070B0D0E0C0E0B0E010402070D0D0E0D0B00190E0A\n"
...
"} bytecompile/apply (source env) #@(documentation: \"Compile the forms in source\" name: bytecompile* cat: :bytecode internal: #t) #{##(resolves? source env resolve op type-of ΓεnΣym-77 :lambda :native-function :pair :symbol :keyword #f ΓεnΣym-78 do bytecompile/do let* bytecompile/let* def bytecompile/def set! bytecompile/set! if bytecompile/if while bytecompile/while and bytecompile/and or bytecompile/or fn* bytecompile/fn* macro* bytecompile/macro* environment* bytecompile/environment* try bytecompile/try return bytecompile/return apply bytecompile/apply quote bytecompile/quote bytecompile/procedure :type-error \"Can't evaluate that\" current-lambda bytecompile/literal)\n"
...
"110E2C0E040E01120E020E01110404160900251A090E050E010401200B00131A\n"
...
"1A000E011A02040207030D0E040B00072409000B0E050E06040105040D0E040E\n"
"050E0304011A000E011A07040226220B001B0E080E031A090E050E0304010E04\n"
...
"1A000E011A02040207030D0E040E0304011A000E011A0504022602011E0B0015\n"
"0E060E031A070E040E030401250402090004240D0E031A000E011A0504020E08\n"
