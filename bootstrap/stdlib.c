...
"2E042F1601\n"
"} reduce (α) #@(documentation: \"Returns the length of collection α\" name: length) #{##(type-of α ΓεnΣym-19 :pair list/length :length)\n"
"150E000E01040107020D0E021A03200B000C0E040E0104010900091A050E0104\n"
"011601\n"
"} length (l f) #@(documentation: \"Runs f over every item in collection l and returns the resulting list\" name: map) #{##(type-of l ΓεnΣym-22 :nil :pair list/map f :array array/map :type-error \"You can only use map with a collection\" current-lambda)\n"
...
"} map (l) #@(documentation: \"Sorts the collection L\" name: sort) #{##(type-of l ΓεnΣym-29 :nil :pair list/sort :array array/sort :type-error \"You can only use sort with a collection\" current-lambda)\n"
...
"04002E042F1601\n"
"} sort (l start end) #@(documentation: \"Return a subcollection of L from START to END\" name: cut) #{##(type-of l ΓεnΣym-36 :pair list/cut start end :array array/cut :string string/cut :type-error \"You can only use member with a collection\" current-lambda)\n"
...
"040AFFD50D0E011601\n"
"} tree/filter (a b) #@(documentation: \"Merge two trees together, if a key is contained in both trees the on in B gets priority\" name: tree/merge) #{##(b a :clone tree/new ret tree/keys ΓεnΣym-14 k)\n"
"0E000B0007240900170E010B000C1A020E0104010900080E03240401010D0E01\n"
"0B00072409000A1A020E000401010D1A020E01040107040D150E050E00040107\n"
