...
"}#{##((a i v) #@(documentation: \"Add V to the value in A at position I and store the result in A returning A\" name: array/+=) #{##(array/set! a i v)\n"
...
"} array/++ (a v) #@(documentation: \"Fills array a with value v\" name: array/fill!) #{##(array/length a len i array/set! v)\n"
"0E000E01040107020D020007030D240900140D0E040E010E030E0504030D0E03\n"
"2305030E030E021E0AFFEA0D0E0101\n"
"} array/fill! (a b) #@(documentation: \"Append array A to array B\" name: array/append) #{##(:array type-of a b throw :type-error \"array/append expects two arrays as its arguments\" current-lambda array/allocate array/length ret i array/set! rl)\n"
...
"0A0D0200070B0D240900170D0E0C0E0A0E0B0E020E0B2B04030D0E0B23050B0E\n"
"0B0E090E0204011E0AFFE30D240D150E090E020401070B0D0E090E0A0401070D\n"
"0D240900200D0E0C0E0A0E0B0E030E0B0E090E020401262B04030D0E0B020103\n"
"050B0E0B0E0D1E0AFFDE160D0E0A0101\n"
"} array/append (a) #@(documentation: \"Duplicate Array A\" name: array/dup) #{##(array/allocate array/length a ret i array/set!)\n"
"0E000E010E020401040107030D020007040D240900170D0E050E030E040E020E\n"
"042B04030D0E042305040E040E010E0204011E0AFFE30D0E0301\n"
"} array/dup (arr fun α) #@(documentation: \"Reduce an array, (reduce) should be preferred\" name: array/reduce) #{##(array/length arr len i fun α)\n"
"0E000E01040107020D020007030D240900170D0E040E050E010E032B04020505\n"
"0D0E032305030E030E021E0AFFE70D0E0501\n"
"} array/reduce (arr fun) #@(documentation: \"Map an array, (map) should be preferred\" name: array/map) #{##(array/length arr len i array/set! fun)\n"
"0E000E01040107020D020007030D2409001B0D0E040E010E030E050E010E032B\n"
"040104030D0E032305030E030E021E0AFFE30D0E0101\n"
"} array/map (arr pred) #@(documentation: \"Filter an array, (filter) should be preferred\" name: array/filter) #{##(ri array/length arr len array/allocate ret ai pred array/set! array/length!)\n"
"020007000D0E010E02040107030D0E040E03040107050D020007060D2409002F\n"
"0D0E070E020E062B04010B001B0E080E050E000E020E062B04030D0E00020125\n"
"0500090004240D0E062305060E060E031E0AFFCF0D0E090E050E00040201\n"
"} array/filter (a b) #@(name: array/equal?) #{##(:array type-of a b not= array/length #f i equal?)\n"
...
"2B04020B0007240900051C010D0E072305070E070E050E0204011E0AFFD90D1B\n"
"01\n"
"} array/equal? (arr val) #@(documentation: \"Append VAL to ARR\" name: array/push) #{##(array/set! array/length! arr array/length val)\n"
"0E000E010E0202010E030E0204012504020E030E0204010201260E04040301\n"
"} array/push (arr i j) #@(documentation: \"Swap values at I and J in ARR\" name: array/swap) #{##(arr i tmp array/set! j)\n"
"0E000E012B07020D0E030E030E000E010E000E042B04030E040E02040301\n"
"} array/swap (arr n at) #@(documentation: \"bubble up the element from index AT to until the max-heap property is satisfied\" name: array/heapify) #{##(at top looping bit-shift-left l r n arr array/swap)\n"
...
"} array/heapify (arr) #@(name: array/make-heap) #{##(array/length arr l div/int l2 array/heapify)\n"
"0E000E01040107020D0E030E020202040207040D240900160D0E050E010E020E\n"
"0404030D0E0402012605040E040200210AFFE80D0E010101\n"
"} array/make-heap (arr) #@(name: array/heap-sort) #{##(array/make-heap arr array/length l array/swap array/heapify)\n"
...
"} array/heap-sort array/sort (arr start end) #@(documentation: \"Return a newly allocated array with the values of ARR from START to END\" name: array/cut) #{##(max start min array/length arr end array/allocate ret i array/set!)\n"
...
"})\n"
"0E000E011A021A031A0417040201\n"
"} remove (a b) #@(name: flatten-λ) #{##(type-of b ΓεnΣym-12 :pair :array :tree #f append reduce flatten-λ a)\n"
...
"} flatten-λ (l) #@(documentation: \"Flatten a collection of collections into a simple list\" name: flatten) #{##(type-of l ΓεnΣym-20 :pair :array :tree #f nreverse reduce flatten-λ)\n"
"150E000E01040107020D0E021A03200C0A001A0D0E021A04200C0A00100D0E02\n"
...
"}#{##((l p) #@(documentation: \"Runs predicate p over every item in collection l and returns a list consiting solely of items where p is true\" name: filter) #{##(type-of l ΓεnΣym-1 :nil :pair list/filter p :array array/filter :tree tree/filter throw :type-error \"You can only filter collections\" current-lambda)\n"
...
"01\n"
"} filter (l f α) #@(documentation: \"Combine all elements in collection l using operation F and starting value α\" name: reduce) #{##(type-of l ΓεnΣym-10 :nil α :tree tree/reduce f :array array/reduce :pair list/reduce throw :type-error \"You can only reduce collections\" current-lambda)\n"
...
"04002E0404011601\n"
"} reduce (α) #@(documentation: \"Returns the length of collection α\" name: length) #{##(type-of α ΓεnΣym-19 :nil :pair list/length :array array/length :tree tree/size :buffer :string :buffer-view #f buffer/length throw :type-error \"You can only use length with a collection\" current-lambda)\n"
...
"04002E0404011601\n"
"} length (l f) #@(documentation: \"Runs f over every item in collection l and returns the resulting list\" name: map) #{##(type-of l ΓεnΣym-31 :nil :pair list/map f :array array/map throw :type-error \"You can only use map with a collection\" current-lambda)\n"
...
"} map (l) #@(documentation: \"Sorts the collection L\" name: sort) #{##(type-of l ΓεnΣym-38 :nil :pair list/sort :array array/sort throw :type-error \"You can only use sort with a collection\" current-lambda)\n"
...
"} sort (l start end) #@(documentation: \"Return a subcollection of L from START to END\" name: cut) #{##(type-of l ΓεnΣym-45 :pair list/cut start end :array array/cut :string string/cut throw :type-error \"You can only use member with a collection\" current-lambda)\n"
...
"} cut)\n"
"1A001A011A021707030D1A041A051A061707070D1A081A091A0A17070B0D1A0C\n"
"1A0D1A0E17070F0D1A101A111A121707130D1A141A151A1617071701\n"
...
"} last-pair (end start step) #@(documentation: \"Return a list containing values from START (inclusive) to END (exclusive) by STEP\" name: range) #{##(end throw :arity-error \"(range) needs at least a specific end\" current-lambda start step number? 0.0 < > pred ret nreverse)\n"
"0E000B0007240900120E011A021A03240E0404002E0404010D0E050B00072409\n"
"0007020005050D0E060B000724090007020105060D0E070E0604010C0B00090D\n"
"0E061A08210B00080E090900050E0A070B0D24070C0D240900130D0E050E0C14\n"
"050C0D0E050E062505050E0B0E050E0004020AFFE80D0E0D0E0C040101\n"
...
"} reverse (l) #@(documentation: \"Returns the length of list l\" name: list/length) #{##(ret l ΓεnΣym-22 e)\n"
"020007000D150E0107020D240900170D0E021107030D0E0002012505000D0E02\n"
"1205020E020AFFEA0D0E001601\n"
"} list/length (l p) #@(documentation: \"Runs predicate p over every item in list l and returns a list consiting solely of items where p is true\" name: list/filter) #{##(ret l ΓεnΣym-25 e p nreverse)\n"
...
"} list/filter (l f) #@(documentation: \"Runs f over every item in list l and returns the resulting list\" name: list/map) #{##(ret l ΓεnΣym-30 e f nreverse)\n"
"2407000D150E0107020D2409001B0D0E021107030D0E040E0304010E00140500\n"
"0D0E021205020E020AFFE60D0E050E0004011601\n"
"} list/map (a b) #@(documentation: \"Appends two lists A and B together\" name: append) #{##(b ret reverse a ΓεnΣym-33 t)\n"
...
"} list/sort/merge list-merge-sort list/sort (a) #@(documentation: \"Return #t is A is a proper list\" name: list?) #{##(a :pair type-of)\n"
"0E000B0007240900051C010D2409001C0D1A010E020E000401200B0007240900\n"
"051C010D0E001205000E000AFFE50D1B0101\n"
"} list? (a b) #@(documentation: \"#t if A and B are equal\" name: list/equal?) #{##(:pair type-of a list/equal? b equal?)\n"
...
"1A251A261707270D1A281A291A2A17072B0D1A2C1A2D1A2E17072F0D1A301A31\n"
"1A321707330D151A341A351A361707370D1A381A391A3A17073B0D1A3C1A3D1A\n"
"3E17073F0D1A401A411A421707431607440D0E4407450D1A461A471A48170749\n"
"0D1A4A1A4B1A4C17074D0D1A4E1A4F1A501707510D1A521A531A541707550D1A\n"
"561A571A581707590D1A5A1A5B1A5C17075D01\n"
"}#{##((keys values) #@(documentation: \"Return a tree where KEYS point to VALUES\" name: tree/zip) #{##(tree/new ret keys ΓεnΣym-1 key tree/set! values)\n"
"0E0024040107010D150E0207030D240900210D0E031107040D0E050E010E040E\n"
"061104030D0E061205060D0E031205030E030AFFE00D0E011601\n"
"} tree/zip (t k v) #@(documentation: \"Increment value at K in T by V\" name: tree/+=) #{##(tree/set! t k v int #f)\n"
...
"} tree/++ (t k) #@(documentation: \"Increment value at K in T by 1\" name: tree/--) #{##(tree/-= t k)\n"
"1A000E010E020201241414141401\n"
"} tree/-- (a b) #@(documentation: \"Compares two trees for equality\" name: tree/equal?) #{##(:tree type-of a b tree/key* equal? tree/value* tree/equal? tree/left* tree/right*)\n"
...
"} tree/equal? (l o s) #@(documentation: \"Combine all elements in l using operation o and starting value s\" name: tree/reduce) #{##(list/reduce tree/values l o s)\n"
"0E000E010E0204010E030E04040301\n"
"} tree/reduce (l f) #@(documentation: \"Return a new tree with all elements from L where F returns true\" name: tree/filter) #{##(tree/new ret tree/keys l ΓεnΣym-9 e t f tree/set!)\n"
...
"} tree/filter (a b) #@(documentation: \"Merge two trees together, if a key is contained in both trees the on in B gets priority\" name: tree/merge) #{##(b a tree/dup tree/new ret tree/keys ΓεnΣym-14 k tree/set!)\n"
...
"}#{##((#nil) #@(documentation: \"() -> () --- Do Nothing\" name: $nop source: (\"() -> () --- Do Nothing\" :cat :bytecode :internal :inline '(0)) cat: :bytecode internal: #t inline: #t) #{##((0))\n"
"1A0001\n"
"} $nop (#nil) #@(documentation: \"(a) -> () --- Return top of value stack\" name: $ret source: (\"(a) -> () --- Return top of value stack\" :cat :bytecode :internal :inline '(1)) cat: :bytecode internal: #t inline: #t) #{##((1))\n"
"1A0001\n"
"} $ret (#nil) #@(documentation: \"(a b) -> (result) --- Adds the two topmost values and pushes the result\" name: $add/int source: (\"(a b) -> (result) --- Adds the two topmost values and pushes the result\" :cat :bytecode :internal :inline '(3)) cat: :bytecode internal: #t inline: #t) #{##((3))\n"
"1A0001\n"
"} $add/int (#nil) #@(documentation: \"(col key) -> (result) --- Looks up key in col\" name: $ref source: (\"(col key) -> (result) --- Looks up key in col\" :cat :bytecode :internal :inline '(43)) cat: :bytecode internal: #t inline: #t) #{##((43))\n"
"1A0001\n"
"} $ref (#nil) #@(documentation: \"(a) -> (a a) --- Duplicates the value that is on the top of the stack\" name: $dup source: (\"(a) -> (a a) --- Duplicates the value that is on the top of the stack\" :cat :bytecode :internal :inline '(12)) cat: :bytecode internal: #t inline: #t) #{##((12))\n"
"1A0001\n"
"} $dup (#nil) #@(documentation: \"(a) -> () --- Drop whatever is on top of the stack\" name: $drop source: (\"(a) -> () --- Drop whatever is on top of the stack\" :cat :bytecode :internal :inline '(13)) cat: :bytecode internal: #t inline: #t) #{##((13))\n"
"1A0001\n"
"} $drop (#nil) #@(documentation: \"() -> (closure) --- Push the current closure as a λ on the stack\" name: $closure/push source: (\"() -> (closure) --- Push the current closure as a λ on the stack\" :cat :bytecode :internal :inline '(19)) cat: :bytecode internal: #t inline: #t) #{##((19))\n"
"1A0001\n"
"} $closure/push (#nil) #@(documentation: \"() -> () --- Create a new let closure and switch to it\" name: $let source: (\"() -> () --- Create a new let closure and switch to it\" :cat :bytecode :internal :inline '(21)) cat: :bytecode internal: #t inline: #t) #{##((21))\n"
"1A0001\n"
"} $let (#nil) #@(documentation: \"() -> () --- Leave the current closure and return to the parent one\" name: $closure/pop source: (\"() -> () --- Leave the current closure and return to the parent one\" :cat :bytecode :internal :inline '(22)) cat: :bytecode internal: #t inline: #t) #{##((22))\n"
"1A0001\n"
"} $closure/pop (#nil) #@(documentation: \"(a b) -> (bool) --- Compare A and B and push the result on the stack\" name: $< source: (\"(a b) -> (bool) --- Compare A and B and push the result on the stack\" :cat :bytecode :internal :inline '(30)) cat: :bytecode internal: #t inline: #t) #{##((30))\n"
"1A0001\n"
"} $< (#nil) #@(documentation: \"(a b) -> (bool) --- Compare A and B and push the result on the stack\" name: $<= source: (\"(a b) -> (bool) --- Compare A and B and push the result on the stack\" :cat :bytecode :internal :inline '(31)) cat: :bytecode internal: #t inline: #t) #{##((31))\n"
"1A0001\n"
"} $<= (#nil) #@(documentation: \"(a b) -> (bool) --- Compare A and B and push the result on the stack\" name: $= source: (\"(a b) -> (bool) --- Compare A and B and push the result on the stack\" :cat :bytecode :internal :inline '(32)) cat: :bytecode internal: #t inline: #t) #{##((32))\n"
"1A0001\n"
"} $= (#nil) #@(documentation: \"(a b) -> (bool) --- Compare A and B and push the result on the stack\" name: $>= source: (\"(a b) -> (bool) --- Compare A and B and push the result on the stack\" :cat :bytecode :internal :inline '(33)) cat: :bytecode internal: #t inline: #t) #{##((33))\n"
"1A0001\n"
"} $>= (#nil) #@(documentation: \"(a b) -> (bool) --- Compare A and B and push the result on the stack\" name: $> source: (\"(a b) -> (bool) --- Compare A and B and push the result on the stack\" :cat :bytecode :internal :inline '(34)) cat: :bytecode internal: #t inline: #t) #{##((34))\n"
"1A0001\n"
"} $> (#nil) #@(documentation: \"() -> (nil) --- Push a #nil on the stack\" name: $push/nil source: (\"() -> (nil) --- Push a #nil on the stack\" :cat :bytecode :internal :inline '(36)) cat: :bytecode internal: #t inline: #t) #{##((36))\n"
"1A0001\n"
"} $push/nil (#nil) #@(documentation: \"(l) -> (car) --- Replace L with its car\" name: $car source: (\"(l) -> (car) --- Replace L with its car\" :cat :bytecode :internal :inline '(17)) cat: :bytecode internal: #t inline: #t) #{##((17))\n"
"1A0001\n"
"} $car (#nil) #@(documentation: \"(l) -> (cdr) --- Replace L with its cdr\" name: $cdr source: (\"(l) -> (cdr) --- Replace L with its cdr\" :cat :bytecode :internal :inline '(18)) cat: :bytecode internal: #t inline: #t) #{##((18))\n"
"1A0001\n"
"} $cdr (#nil) #@(documentation: \"(l) -> (cadr) --- Replace L with its cadr\" name: $cadr source: (\"(l) -> (cadr) --- Replace L with its cadr\" :cat :bytecode :internal :inline '(44)) cat: :bytecode internal: #t inline: #t) #{##((44))\n"
"1A0001\n"
"} $cadr (#nil) #@(documentation: \"(car cdr) -> (pair) --- Cons CAR and CDR together and put it on the stack\" name: $cons source: (\"(car cdr) -> (pair) --- Cons CAR and CDR together and put it on the stack\" :cat :bytecode :internal :inline '(20)) cat: :bytecode internal: #t inline: #t) #{##((20))\n"
"1A0001\n"
"} $cons (#nil) #@(documentation: \"(args meta body) -> (λ) --- Create a new λ\" name: $fn/new source: (\"(args meta body) -> (λ) --- Create a new λ\" :cat :bytecode :internal :inline '(23)) cat: :bytecode internal: #t inline: #t) #{##((23))\n"
"1A0001\n"
"} $fn/new (#nil) #@(documentation: \"(args meta body) -> (μ) --- Create a new μ\" name: $macro/new source: (\"(args meta body) -> (μ) --- Create a new μ\" :cat :bytecode :internal :inline '(24)) cat: :bytecode internal: #t inline: #t) #{##((24))\n"
"1A0001\n"
"} $macro/new (#nil) #@(documentation: \"(name args docs body) -> (λ) --- Create a new λ\" name: $fn/dynamic source: (\"(name args docs body) -> (λ) --- Create a new λ\" :cat :bytecode :internal :inline '(47)) cat: :bytecode internal: #t inline: #t) #{##((47))\n"
"1A0001\n"
"} $fn/dynamic (#nil) #@(documentation: \"(name args docs body) -> (μ) --- Create a new μ\" name: $macro/dynamic source: (\"(name args docs body) -> (μ) --- Create a new μ\" :cat :bytecode :internal :inline '(48)) cat: :bytecode internal: #t inline: #t) #{##((48))\n"
"1A0001\n"
"} $macro/dynamic (#nil) #@(documentation: \"(a b) -> (result)\" name: $add source: (\"(a b) -> (result)\" :cat :bytecode :internal :inline '(37)) cat: :bytecode internal: #t inline: #t) #{##((37))\n"
"1A0001\n"
"} $add (#nil) #@(documentation: \"(a b) -> (result)\" name: $sub source: (\"(a b) -> (result)\" :cat :bytecode :internal :inline '(38)) cat: :bytecode internal: #t inline: #t) #{##((38))\n"
"1A0001\n"
"} $sub (#nil) #@(documentation: \"(a b) -> (result)\" name: $mul source: (\"(a b) -> (result)\" :cat :bytecode :internal :inline '(39)) cat: :bytecode internal: #t inline: #t) #{##((39))\n"
"1A0001\n"
"} $mul (#nil) #@(documentation: \"(a b) -> (result)\" name: $div source: (\"(a b) -> (result)\" :cat :bytecode :internal :inline '(40)) cat: :bytecode internal: #t inline: #t) #{##((40))\n"
"1A0001\n"
"} $div (#nil) #@(documentation: \"(a b) -> (result)\" name: $rem source: (\"(a b) -> (result)\" :cat :bytecode :internal :inline '(41)) cat: :bytecode internal: #t inline: #t) #{##((41))\n"
"1A0001\n"
"} $rem (#nil) #@(documentation: \"() -> (#t)\" name: $push/true source: (\"() -> (#t)\" :cat :bytecode :internal :inline '(27)) cat: :bytecode internal: #t inline: #t) #{##((27))\n"
"1A0001\n"
"} $push/true (#nil) #@(documentation: \"() -> (#f)\" name: $push/false source: (\"() -> (#f)\" :cat :bytecode :internal :inline '(28)) cat: :bytecode internal: #t inline: #t) #{##((28))\n"
"1A0001\n"
"} $push/false (#nil) #@(documentation: \"(bc env) -> (return-val)\" name: $eval source: (\"(bc env) -> (return-val)\" :cat :bytecode :internal :inline '(29)) cat: :bytecode internal: #t inline: #t) #{##((29))\n"
"1A0001\n"
"} $eval (#nil) #@(documentation: \"(bc env) -> (return-val)\" name: $mutable-eval source: (\"(bc env) -> (return-val)\" :cat :bytecode :internal :inline '(45)) cat: :bytecode internal: #t inline: #t) #{##((45))\n"
"1A0001\n"
"} $mutable-eval (#nil) #@(documentation: \"(a) -> (result)\" name: $zero? source: (\"(a) -> (result)\" :cat :bytecode :internal :inline '(42)) cat: :bytecode internal: #t inline: #t) #{##((42))\n"
"1A0001\n"
"} $zero? (#nil) #@(documentation: \"(a) -> (result) --- Adds 1 to the topmost int\" name: $inc/int source: (\"(a) -> (result) --- Adds 1 to the topmost int\" :cat :bytecode :internal :inline '(35)) cat: :bytecode internal: #t inline: #t) #{##((35))\n"
"1A0001\n"
"} $inc/int (a) #@(name: int-fit-in-byte?) #{##(a)\n"
...
"} $push/int (a) #@(documentation: \"() -> (a) --- Push A on the stack as an :int that fits within a byte\" name: $push/int/byte cat: :bytecode internal: #t) #{##(int-fit-in-byte? a throw :invalid-bc-op \"$push/int/byte can only push a signed 8-bit value\" current-lambda)\n"
"0E000E0104010B0007240900130E021A031A040E010E0504002E0404010D0202\n"
"0E012E0201\n"
"} $push/int/byte (arg-count fun) #@(documentation: \"arguments -> (result) --- Read arg-count arguments from the stack, apply the to fun and push the result on the stack\" name: $apply/optimized cat: :bytecode internal: #t) #{##(fun list $list arg-count ΓεnΣym-6 ΓεnΣym-7 car (17) cdr (18) cadr (44) zero? (42) inc/int (35) ΓεnΣym-8 add/int (3) ref (43) + (37) - (38) * (39) / (40) rem (41) cons (20) < (30) <= (31) = (32) >= (33) > (34) bytecode-eval* (29) mutable-eval* (45))\n"
...
"16090004241601\n"
"} $apply/optimized (arg-count fun) #@(documentation: \"arguments -> (result) --- Read arg-count arguments from the stack, apply the to fun and push the result on the stack\" name: $apply cat: :bytecode internal: #t) #{##(arg-count 255 throw :arity-error \"Functions can only take up to 255 arguments directly, try to pass a list/array/map instead\" current-lambda)\n"
"0E001A01220B00160E021A031A040E000E0504002E040401090004240D02040E\n"
"002E0201\n"
"} $apply (count) #@(documentation: \"arguments -> (result) --- Read count arguments from the stack and put a list of those on the stack instead.\" name: $list cat: :bytecode internal: #t) #{##(count 255 throw :arity-error \"$list can only generate lists with up to 255 arguments in one go, try and use cons instead\" current-lambda)\n"
"0E001A01220B00160E021A031A040E000E0504002E040401090004240D022E0E\n"
"002E0201\n"
...
"} $try (target) #@(name: $jmp cat: :bytecode internal: #t) #{##(:relocate target)\n"
"02091A000E010208020002002E051A000E010200020102002E052E0301\n"
"} $jmp (v) #@(documentation: \"() -> (v) --- Pushes v onto the stack\" name: $push/val cat: :bytecode internal: #t) #{##(nil? v throw :invalid-bc-op \"Can't push #nil as a normal lVal\" current-lambda :literal)\n"
"0E000E0104010B00160E021A031A040E010E0504002E040401090004240D021A\n"
"1A060E012E022E0201\n"
"} $push/val (v) #@(documentation: \"() -> (v) --- Resolve V and get the associated value on the stack\" name: $get/val cat: :bytecode internal: #t) #{##(:symbol type-of v throw :invalid-bc-op \"Can only get symbol\" current-lambda :literal)\n"
"1A000E010E020401200B0007240900130E031A041A050E020E0604002E040401\n"
"0D020E1A070E022E022E0201\n"
"} $get/val (v) #@(documentation: \"(v) -> (v) --- Resolve V and get the associated value on the stack\" name: $set/val cat: :bytecode internal: #t) #{##(:symbol type-of v throw :invalid-bc-op \"Can only get symbol\" current-lambda :literal)\n"
"1A000E010E020401200B0007240900130E031A041A050E020E0604002E040401\n"
"0D02051A070E022E022E0201\n"
"} $set/val (v) #@(documentation: \"(v) -> (v) --- Resolve V and get the associated value on the stack\" name: $def/val cat: :bytecode internal: #t) #{##(:symbol type-of v throw :invalid-bc-op \"Can only get symbol\" current-lambda :literal)\n"
"1A000E010E020401200B0007240900130E031A041A050E020E0604002E040401\n"
"0D02071A070E022E022E0201\n"
...
"} $macro* (code sym-map pos) #@(name: assemble/build-sym-map) #{##(type-of code ΓεnΣym-67 :int tree/set! sym-map :last-op pos :keyword ΓεnΣym-68 :label :relocate :literal :pair assemble/build-sym-map)\n"
"240900A30D150E000E0111040107020D0E021A03200B00150E040E051A060E07\n"
"020125050704030900760E021A08200B0055150E011107090D0E091A0A200B00\n"
"150E040E050E012C0E0704030D0E07010900300E091A0B200B00190E040E051A\n"
"060E07020125050704030D0E07010900120E091A0C200B00090E070109000424\n"
"1609001C0E021A0D200B00130E0E0E01110E050E070403050709000424160D0E\n"
"011205010E010AFF5E0D0E070101\n"
"} assemble/build-sym-map (code sym-map pos out) #@(name: assemble/relocate-op) #{##(sym-map code target pos off array/set! out bit-and bit-shift-right 255)\n"
"0E000E012C2B07020D0E020E0112121211250E032607040D0E050E060E030201\n"
"2505030E070E080E040E0112121104021A09040204030D0E030101\n"
"} assemble/relocate-op (code sym-map pos out) #@(name: assemble/emit-relocated-ops) #{##(code :relocate assemble/relocate-op sym-map pos out ΓεnΣym-83 op type-of ΓεnΣym-84 :int array/set! :pair assemble/emit-relocated-ops)\n"
...
"} assemble/emit-relocated-ops (i) #@(name: literal-index->bytecode-op) #{##(i 256 bit-and bit-shift-right 255)\n"
"0E001A011E0B00080E0009001B0E020E030E00020804021A0404020E020E001A\n"
"0404022E0201\n"
"} literal-index->bytecode-op *max-literal-arr* (lit lit-arr) #@(name: assemble/add-literal) #{##(array/length lit-arr 65535 throw :out-of-bounds \"Can only store up to 255 literals per bytecode-arr\" code current-lambda not= type-of lit :pair i equal? literal-index->bytecode-op array/length! array/set!)\n"
"0E000E0104011A02210B00160E031A041A050E060E0704002E04040109000424\n"
"0D0E080E090E0A04011A0B04020B003D0200070C0D240900230D0E0D0E010E0C\n"
"2B0E0A04020B000D0E0E0E0C040101090004240D0E0C23050C0E0C0E000E0104\n"
"011E0AFFD70D24090004240D0E0F0E0102010E000E0104012504020D0E100E01\n"
"0E000E0104010201260E0A04030D0E0E0E000E010401020126040101\n"
"} assemble/add-literal (code lit-arr) #@(name: assemble/build-lit-arr) #{##(code :pair type-of assemble/build-lit-arr lit-arr :literal assemble/add-literal index-op otherwise)\n"
...
"200B003A0E001205000D0E060E001112110E04040207070D1A010E020E070401\n"
...
"0207070D1A010E020E070401200B0008020F090005020E0E070E030E00120E04\n"
"040214140900D60E00110205200C0B000B0D0E002C111A05200B003A0E001205\n"
"000D0E060E001112110E04040207070D1A010E020E070401200B000802100900\n"
"0502050E070E030E00120E040402141409008A0E00110207200C0B000B0D0E00\n"
"2C111A05200B003A0E001205000D0E060E001112110E04040207070D1A010E02\n"
...
"} assemble/build-lit-arr (code ret) #@(name: assemble/flatten) #{##(code ret :pair type-of assemble/flatten :keyword)\n"
...
"110E011401\n"
"} assemble/flatten (code) #@(documentation: \"Assemble all arguments into a single :bytecode-array\" name: assemble* cat: :bytecode internal: #t) #{##(tree/new sym-map array/new lit-arr assemble/build-lit-arr assemble/flatten code tmp assemble/build-sym-map array/allocate :last-op out assemble/emit-relocated-ops arr->bytecode-arr)\n"
...
"1AC01AC11AC21707C30D1AC41AC51AC61707C70D151AC81AC91ACA1707CB0D1A\n"
"CC1ACD1ACE1707CF0D1AD01AD11AD21707D30D1AD41AD51AD61707D70D020007\n"
"D80D1AD91ADA1ADB1707DC0D1ADD1ADE1ADF1707E00D1AE11AE21AE31707E40D\n"
"1AE51AE61AE71707E81607E80D1AE91AEA1AEB1707EC0D1AED1AEE1AEF1807F0\n"
"01\n"
"}#{##((source) #@(name: bytecompile/literal) #{##(type-of source ΓεnΣym-1 :int $push/int :nil (36) :bool (27) (28) :symbol $get/val :native-function :lambda #f bytecompile/literal closure/name $push/val)\n"
...
"} bytecompile/literal (source) #@(name: bytecompile/quote) #{##(type-of source ΓεnΣym-15 :nil (36) :int $push/int $push/val)\n"
...
"} bytecompile/do (source env) #@(name: bytecompile/def) #{##(:symbol type-of source #f throw :type-error \"(def) needs a symbol name and a value as arguments\" env bytecompile* $def/val)\n"
...
"} bytecompile/def (source env) #@(name: bytecompile/set!) #{##(:symbol type-of source #f throw :type-error \"(set!) needs a symbol name and a value as arguments\" env bytecompile* $set/val)\n"
"1A000E010E022C0401200B00071C0900041B0C0A00170D0E0212120B00071C09\n"
"00041B0C0A00060D1A030B00130E041A051A06240E072E040401090004240D0E\n"
"080E021212110E0704020E090E022C04012E0201\n"
...
"040401\n"
"} bytecompile/procedure (op args env op-raw) #@(name: bytecompile/procedure/default) #{##(procedure? op :symbol type-of :pair throw :type-error \"Can't apply to that\" current-lambda length args arg-count $apply/optimized optimized bytecompile/procedure/arg bytecompile* op-raw env $apply)\n"
...
"} bytecompile/or (source env) #@(name: bytecompile/fn*) #{##(length source arg-count not= throw :arity-error \"(fn*) needs exactly 4 arguments\" current-lambda bytecompile* env (23))\n"
...
"04020E080E011212110E0904021A0A2E0401\n"
"} bytecompile/fn* (source env) #@(name: bytecompile/macro*) #{##(length source arg-count not= throw :arity-error \"(macro*) needs exactly 4 arguments\" current-lambda bytecompile* env (24))\n"
"0E000E0112040107020D0E030E02020504020B00160E041A051A060E010E0704\n"
"002E040401090004240D0E011205010D0E080E01110E0904020E080E012C0E09\n"
"04020E080E011212110E0904021A0A2E0401\n"
...
"} bytecompile/try (source env) #@(documentation: \"Compile the forms in source\" name: bytecompile* cat: :bytecode internal: #t) #{##(resolves? source env resolve op type-of ΓεnΣym-69 :lambda :native-function :pair :symbol #f ΓεnΣym-70 do bytecompile/do let* bytecompile/let* def bytecompile/def set! bytecompile/set! if bytecompile/if while bytecompile/while and bytecompile/and or bytecompile/or fn* bytecompile/fn* macro* bytecompile/macro* environment* bytecompile/environment* try bytecompile/try return bytecompile/return quote bytecompile/quote bytecompile/procedure throw :type-error \"Can't evaluate that\" current-lambda bytecompile/literal)\n"
...
"591A5A17075B0D1A5C1A5D1A5E17075F16075F0D1A601A611A6217076301\n"
"}#{##((op) #@(documentation: \"Return the length in bytes of a bytecode operation and all its arguments\" name: disassemble/length) #{##(op ΓεnΣym-1 #f throw :unknown-op \"This op needs its length specified for disassembly to work\" current-lambda)\n"
"150E0007010D0E010200200C0A01460D0E010201200C0A013C0D0E010203200C\n"
"0A01320D0E01020C200C0A01280D0E01020D200C0A011E0D0E010211200C0A01\n"
"140D0E010212200C0A010A0D0E010213200C0A01000D0E010214200C0A00F60D\n"
"0E010215200C0A00EC0D0E010216200C0A00E20D0E010217200C0A00D80D0E01\n"
"0218200C0A00CE0D0E010219200C0A00C40D0E01021B200C0A00BA0D0E01021C\n"
"200C0A00B00D0E01021D200C0A00A60D0E01021E200C0A009C0D0E01021F200C\n"
"0A00920D0E010220200C0A00880D0E010221200C0A007E0D0E010222200C0A00\n"
"740D0E010223200C0A006A0D0E010224200C0A00600D0E010225200C0A00560D\n"
"0E010226200C0A004C0D0E010227200C0A00420D0E010228200C0A00380D0E01\n"
"0229200C0A002E0D0E01022A200C0A00240D0E01022B200C0A001A0D0E01022C\n"
"200C0A00100D0E01022D200C0A00060D1A020B000802010900B30E010202200C\n"
"0A00420D0E010204200C0A00380D0E010205200C0A002E0D0E010207200C0A00\n"
"240D0E01020E200C0A001A0D0E01021A200C0A00100D0E01022E200C0A00060D\n"
"1A020B000802020900630E010206200C0A00420D0E010208200C0A00380D0E01\n"
"0209200C0A002E0D0E01020A200C0A00240D0E01020B200C0A001A0D0E01020F\n"
"200C0A00100D0E010210200C0A00060D1A020B000802030900130E031A041A05\n"
"0E000E0604002E0404011601\n"
"} disassemble/length (error) #@(name: bytecode/nil-catcher) #{##(error :type-error throw)\n"
...
"0E0019001D0E010E020E032B0E0202010E03252B0E0202020E03252B04031601\n"
"} bytecode-arr->sym (a b) #@(documentation: \"Turn two bytecode ops encoding an offset into the integer representation\" name: bytecode-op->offset) #{##(bit-or bit-shift-left a b t 32768 - 65536)\n"
"0E000E010E02020804020E03040207040D0E041A05220B000F0E061A070E0426\n"
"04010900050E0401\n"
...
"} bytecode-arr->offset (v) #@(documentation: \"Quotes symbols but just passes through every other value\" name: disassemble/maybe-quote) #{##(:symbol type-of v quote :bytecode-array disassemble/bytecode-array)\n"
"1A000E010E020401200B000C1A030E022E020900221A040E010E020401200B00\n"
"0C0E050E02040109000D1B0B00080E020900042401\n"
"} disassemble/maybe-quote (a i literals) #@(documentation: \"Disassemble a single bytecode op in A at I and return it as an s-expression, that could be applied to eval\" name: disassemble/op) #{##(a i ΓεnΣym-23 ($nop) ($ret) $push/int/byte ($add/int) $apply $set/val disassemble/maybe-quote literals $push/val/ext bit-or bit-shift-left $def/val $def/val/ext $jmp* bytecode-arr->offset $jt* $jf* ($dup) ($drop) $get/val $get/val/ext $set/val/ext ($car) ($cdr) ($closure/push) ($cons) ($let) ($closure/pop) ($fn/dynamic) ($macro/dynamic) $try $push/val ($push/true) ($push/false) ($eval) ($<) ($<=) ($=) ($>=) ($>) ($inc/int) ($push/nil) ($add) ($sub) ($mul) ($div) ($rem) ($zero?) ($ref) ($cadr) ($mutable-eval) $list :unknown-op)\n"
"150E000E012B07020D0E020200200B00081A030903800E020201200B00081A04\n"
"0903730E020202200B00131A050E000E010201252B24141409035B0E02020320\n"
"0B00081A0609034E0E020204200B00131A070E000E010201252B241414090336\n"
"0E020205200B001A1A080E090E0A0E000E010201252B2B04012414140903170E\n"
"020206200B002C1A0B0E0A0E0C0E0C0E000E010201252B0E0D0E000E01020225\n"
"2B04010402020804022B2414140902E60E020207200B001A1A0E0E090E0A0E00\n"
"0E010201252B2B04012414140902C70E020208200B00281A0F0E0A0E0C0E000E\n"
"010201252B0E0D0E000E010202252B0208040204022B24141409029A0E020209\n"
"200B00161A100E110E000E01020125040224141409027F0E02020A200B00161A\n"
"120E110E000E0102012504022414140902640E02020B200B00161A130E110E00\n"
"0E0102012504022414140902490E02020C200B00081A1409023C0E02020D200B\n"
"00081A1509022F0E02020E200B001A1A160E090E0A0E000E010201252B2B0401\n"
"2414140902100E02020F200B00281A170E0A0E0C0E000E010201252B0E0D0E00\n"
"0E010202252B0208040204022B2414140901E30E020210200B00281A180E0A0E\n"
"0C0E000E010201252B0E0D0E000E010202252B0208040204022B2414140901B6\n"
"0E020211200B00081A190901A90E020212200B00081A1A09019C0E020213200B\n"
"00081A1B09018F0E020214200B00081A1C0901820E020215200B00081A1D0901\n"
"750E020216200B00081A1E0901680E020217200B00081A1F09015B0E02021820\n"
"0B00081A2009014E0E020219200B00161A210E110E000E010201250402241414\n"
"0901330E02021A200B001A1A220E090E0A0E000E010201252B2B040124141409\n"
"01140E02021B200B00081A230901070E02021C200B00081A240900FA0E02021D\n"
"200B00081A250900ED0E02021E200B00081A260900E00E02021F200B00081A27\n"
"0900D30E020220200B00081A280900C60E020221200B00081A290900B90E0202\n"
"22200B00081A2A0900AC0E020223200B00081A2B09009F0E020224200B00081A\n"
"2C0900920E020225200B00081A2D0900850E020226200B00081A2E0900780E02\n"
"0227200B00081A2F09006B0E020228200B00081A3009005E0E020229200B0008\n"
"1A310900510E02022A200B00081A320900440E02022B200B00081A330900370E\n"
"02022C200B00081A3409002A0E02022D200B00081A3509001D0E02022E200B00\n"
"131A360E000E010201252B2414140900051A371601\n"
...
"} disassemble/array (code) #@(documentation: \"Disassemble the bytecode array CODE, turning it into a list of dotted pairs, with the car containing the offset and the cdr containing assembler S-Expressions,\" name: disassemble/bytecode-array) #{##(disassemble/array bytecode-arr->arr code bytecode-literals)\n"
...
"} backend (backend expr environment) #@(name: compile/for) #{##(*active-backend* last-backend ret (e) #@(name: anonymous) #{##(last-backend *active-backend* throw e)\n"
...
"} compile* (source environment) #@(name: compile/do* cat: :compiler internal: #t) #{##(:pair type-of source compile* do environment)\n"
...
"} compile (name args body) #@(name: meta/parse/body cat: :compiler internal: #t) #{##(body source tree/new :name name meta v type-of ΓεnΣym-3 :pair deftest tree/set! :tests :string :documentation cat string \"\\n\" :keyword ΓεnΣym-4 :inline :source :related :export-as :export :cat trim join map split)\n"
...
"} defmacro (args body) #@(name: fn/check cat: :compiler internal: #t) #{##(args throw :type-error \"Every function needs an argument list\" current-lambda :symbol type-of :pair #f \"Wrong type for argument list\" body \"Every function needs a body\")\n"
...
"} fn (name args . body) #@(documentation: \"Define a new function\" name: defn) #{##(fn/check args body meta/parse/body name fn-meta def fn* quote compile/do* current-closure def-form :export export :symbol type-of)\n"
...
"0E051A0C2B0B00251A0D1A0E0E0F0E051A0C2B0401200B000B0E051A0C2B0900\n"
...
"} eval (v t) #@(name: typecheck/only) #{##(when-not = type-of v t throw list :type-error cat \"Expected a value of type \" current-lambda)\n"
"1A001A011A020E032414140E04241414141A051A061A070E081A090E0404020E\n"
"031A0A24142414141414142414142414141401\n"
"} typecheck/only gensym/counter (prefix) #@(name: gensym) #{##(gensym/counter string->symbol cat prefix \"ΓεnΣym-\")\n"
...
"01\n"
"}#{##((expr) #@(name: constant-fold/constant?) #{##(:pair type-of expr :symbol)\n"
...
"0E000E011A02040201\n"
"} constant-fold/pure? (sym) #@(name: constant-fold/resolve) #{##(:symbol type-of sym resolve)\n"
"1A000E010E020401200B0007240900060E02010D0E030E02040101\n"
"} constant-fold/resolve (expr) #@(name: constant-fold/args) #{##(expr :pair type-of constant-fold constant-fold/args)\n"
...
"080E060E0904020B001D1A0A1A0B1A0C171900100E0D0E0E0E0304010E060402\n"
"160900080E030E061401\n"
"} constant-fold)\n"
"151A001A011A021707030D1A041A051A061707070D1A081A091A0A17070B0D1A\n"
"0C1A0D1A0E17070F0D1A101A111A1217071316071301\n"
"}#{##((args env) #@(name: macroexpand-do-args) #{##(nil? args macroexpand* env :pair type-of ocar macroexpand-do-args)\n"
...
"01\n"
"} macroexpand-do (source env op arity implicit-do? no-expand-bitmap) #@(name: macroexpand-form) #{##(op ret source l i bit-test? no-expand-bitmap macroexpand* env arity implicit-do? macroexpand-do throw :arity-error cat \" form contains more than \" \" arguments\" nreverse)\n"
...
"00240E030B001E0E0C1A0D0E0E0E001A0F0E091A1004040E020E082E04040109\n"
"0004240D0E110E0104010101\n"
...
"} macroexpand-fold (source env) #@(documentation: \"Expand all macros within source\" name: macroexpand* cat: :compiler internal: #t) #{##(resolves? source env resolve op type-of ΓεnΣym-21 :nil :macro macroexpand* apply :native-function ΓεnΣym-22 quote do macroexpand-do return macroexpand-form try while #f def set! if fn* macro* let* environment* meta :fold macroexpand-fold map (α) #@(name: anonymous) #{##(macroexpand* α env)\n"
"0E000E010E02040201\n"
"} (α) #{##(macroexpand* α env)\n"
"0E000E010E02040201\n"
"})\n"
"0E000E01110E0204020B000F0E030E01110E0204020900060E011107040D150E\n"
"050E04040107060D0E061A07200B00080E0109015E0E061A08200B00150E090E\n"
"0A0E040E011204020E0204020901440E061A0B200B012F150E04070C0D0E0C0E\n"
"0D200B00080E010901180E0C0E0E200B000E0E0F0E010E0204020901050E0C0E\n"
"10200B00150E110E010E020E0402011C020004060900EB0E0C0E12200C0A0010\n"
"0D0E0C0E13200C0A00060D1A140B00150E110E010E020E0402011B0200040609\n"
"00C00E0C0E15200C0A00100D0E0C0E16200C0A00060D1A140B00150E110E010E\n"
"020E0402021C020104060900950E0C0E17200B00150E110E010E020E0402031C\n"
"0200040609007B0E0C0E18200C0A00100D0E0C0E19200C0A00060D1A140B0015\n"
"0E110E010E020E0402041B020704060900500E0C0E1A200C0A00100D0E0C0E1B\n"
"200C0A00060D1A140B00130E040E0F0E01120E0204022E020900270E1C0E041A\n"
"1D04020B000F0E1E0E040E011204020900100E1F0E011A201A211A2217040216\n"
"0900100E1F0E011A231A211A241704021601\n"
...
"} let (v) #@(documentation: \"Coerce to boolean\" name: boolean source: (\"Coerce to boolean\" :inline :cat :boolean-operations :related not (deftest #t (boolean #t)) (deftest #f (boolean #nil)) (deftest #f (boolean #f)) (deftest #t (boolean 0)) (deftest #t (boolean 1)) (deftest #t (boolean 0.1)) (deftest #t (boolean \"\")) (deftest #t (boolean \"a\")) (if v #t #f)) cat: :boolean-operations tests: ((#t (boolean \"a\")) (#t (boolean \"\")) (#t (boolean 0.1)) (#t (boolean 1)) (#t (boolean 0)) (#f (boolean #f)) (#f (boolean #nil)) (#t (boolean #t))) inline: #t related: (not)) #{##(v)\n"
"0E000B00071B0900041C01\n"
"} boolean (v) #@(documentation: \"Return true if V is false\" name: not source: (\"Return true if V is false\" :inline :cat :boolean-operations :related boolean (deftest #f (not #t)) (deftest #t (not #f)) (deftest #t (not (< 5 1))) (deftest #t (not (= #f #t))) (deftest #t (not (< 3 2))) (if v #f #t)) cat: :boolean-operations tests: ((#t (not (< 3 2))) (#t (not (= #f #t))) (#t (not (< 5 1))) (#t (not #f)) (#f (not #t))) inline: #t related: (boolean)) #{##(v)\n"
"0E000B00071C0900041B01\n"
"} not (α) #@(documentation: \"Returns its argument\" name: identity source: (:inline \"Returns its argument\" α) inline: #t) #{##(α)\n"
"0E0001\n"
"} identity (p) #@(documentation: \"(car (car p))\" name: caar source: (\"(car (car p))\" :inline :cat :list-manipulation :related cadr :related car :related cdr (deftest #t (caar '((#t) #f))) (car (car p))) cat: :list-manipulation tests: ((#t (caar '((#t) #f)))) inline: #t related: (cdr car cadr)) #{##(p)\n"
"0E00111101\n"
"} caar (p) #@(documentation: \"(cdr (car p))\" name: cdar source: (\"(cdr (car p))\" :inline :cat :list-manipulation :related caar :related car :related cdr (deftest #t (cdar '((#f . #t) #f))) (deftest (#t) (cdar '((#f #t) #f))) (cdr (car p))) cat: :list-manipulation tests: (((#t) (cdar '((#f #t) #f))) (#t (cdar '((#f . #t) #f)))) inline: #t related: (cdr car caar)) #{##(p)\n"
"0E00111201\n"
"} cdar (p) #@(documentation: \"(cdr (cdr p))\" name: cddr source: (\"(cdr (cdr p))\" :inline :cat :list-manipulation :related caar :related car :related cdr (deftest #t (cddr '(#f #f . #t))) (deftest (#t) (cddr '(#f #f #t))) (cdr (cdr p))) cat: :list-manipulation tests: (((#t) (cddr '(#f #f #t))) (#t (cddr '(#f #f . #t)))) inline: #t related: (cdr car caar)) #{##(p)\n"
"0E00121201\n"
"} cddr (p) #@(documentation: \"(car (cdr (car p)))\" name: cadar source: (\"(car (cdr (car p)))\" :inline :cat :list-manipulation :related caar :related car :related cdr (deftest #t (cadar '((#f #t) #f))) (car (cdr (car p)))) cat: :list-manipulation tests: ((#t (cadar '((#f #t) #f)))) inline: #t related: (cdr car caar)) #{##(p)\n"
"0E0011121101\n"
"} cadar (p) #@(documentation: \"(car (cdr (cdr p)))\" name: caddr source: (\"(car (cdr (cdr p)))\" :inline :cat :list-manipulation :related caar :related car :related cdr (deftest #t (caddr '(#f #f #t))) (car (cdr (cdr p)))) cat: :list-manipulation tests: ((#t (caddr '(#f #f #t)))) inline: #t related: (cdr car caar)) #{##(p)\n"
"0E0012121101\n"
"} caddr (p) #@(documentation: \"(cdr (cdr (cdr p)))\" name: cdddr source: (\"(cdr (cdr (cdr p)))\" :inline :cat :list-manipulation :related caar :related car :related cdr (deftest #t (cdddr '(#f #f #f . #t))) (deftest (#t) (cdddr '(#f #f #f #t))) (cdr (cdr (cdr p)))) cat: :list-manipulation tests: (((#t) (cdddr '(#f #f #f #t))) (#t (cdddr '(#f #f #f . #t)))) inline: #t related: (cdr car caar)) #{##(p)\n"
"0E0012121201\n"
"} cdddr (p) #@(documentation: \"(car (cdr (cdr (cdr p))))\" name: cadddr source: (\"(car (cdr (cdr (cdr p))))\" :inline :cat :list-manipulation :related caar :related car :related cdr (deftest #t (cadddr '(#f #f #f #t))) (car (cdr (cdr (cdr p))))) cat: :list-manipulation tests: ((#t (cadddr '(#f #f #f #t)))) inline: #t related: (cdr car caar)) #{##(p)\n"
"0E001212121101\n"
"} cadddr (p) #@(documentation: \"(cdr (cdr (cdr (cdr p))))\" name: cddddr source: (\"(cdr (cdr (cdr (cdr p))))\" :inline :cat :list-manipulation :related caar :related car :related cdr (deftest #t (cddddr '(#f #f #f #f . #t))) (cdr (cdr (cdr (cdr p))))) cat: :list-manipulation tests: ((#t (cddddr '(#f #f #f #f . #t)))) inline: #t related: (cdr car caar)) #{##(p)\n"
"0E001212121201\n"
"} cddddr (p) #@(documentation: \"(car (cdr (cdr (cdr (cdr p)))))\" name: caddddr source: (\"(car (cdr (cdr (cdr (cdr p)))))\" :inline :cat :list-manipulation :related caar :related car :related cdr (deftest #t (caddddr '(#f #f #f #f #t))) (car (cdr (cdr (cdr (cdr p)))))) cat: :list-manipulation tests: ((#t (caddddr '(#f #f #f #f #t)))) inline: #t related: (cdr car caar)) #{##(p)\n"
"0E00121212121101\n"
"} caddddr (p) #@(documentation: \"(cdr (cdr (cdr (cdr (cdr p)))))\" name: cdddddr source: (\"(cdr (cdr (cdr (cdr (cdr p)))))\" :inline :cat :list-manipulation :related caar :related car :related cdr (deftest #t (cdddddr '(#f #f #f #f #f . #t))) (cdr (cdr (cdr (cdr (cdr p)))))) cat: :list-manipulation tests: ((#t (cdddddr '(#f #f #f #f #f . #t)))) inline: #t related: (cdr car caar)) #{##(p)\n"
"0E00121212121201\n"
...
"} case/clauses/multiple (key-sym clauses) #@(name: case/clauses internal: #t) #{##(clauses otherwise do if :pair type-of quote nil? :symbol = key-sym or case/clauses/multiple case/clauses)\n"
...
"0E000E01040101\n"
"} cond (binding . body) #@(documentation: \"binding => (name n result-form)\\nRepeatedly executes body with name bound to integers from 0 through n-1. Returns result-form or #nil.\" name: dotimes) #{##(binding sym type-of :symbol throw :type-error \"Expected a value of type :symbol\" current-lambda times result-form do def while < append body set! inc/int)\n"
"0E001107010D0E020E0104011A03200B0007240900130E041A051A060E010E07\n"
"04002E0404010D0E002C07080D0E0012121107090D1A0A1A0B0E010200241414\n"
"141A0C1A0D0E010E08241414140E0E0E0F1A100E011A110E0124141424141414\n"
"2414040214140E09241414141401\n"
...
"14141401\n"
"} doseq (init fun) #@(name: thread/-> internal: #t) #{##(fun :pair type-of thread/-> init append)\n"
...
"} module/restore-state (module-name symbol) #@(name: module/qualify-symbol cat: :modules internal: #t) #{##(type-of module-name ΓεnΣym-1 :string module/qualify-symbol string->keyword symbol :keyword string->symbol cat keyword->symbol \"/\" string throw \"Can't qualify that\" current-lambda)\n"
...
"} module/qualify-symbol (module env qualify?) #@(name: require* cat: :modules internal: #t) #{##(module/load module env mod throw \"Can't load that module\" current-lambda resolve exports tree/keys ΓεnΣym-6 k def-in! qualify? module/qualify-symbol keyword->symbol)\n"
...
"} module/load/store (name) #@(name: module/load/external cat: :modules internal: #t) #{##(module/loader ΓεnΣym-15 loader name mod tree/set! module/cache)\n"
...
"} module/load/external (name module-source) #@(name: module/insert/defer cat: :modules internal: #t) #{##(tree/set! module/store name module-source)\n"
"0E000E010E020E03040301\n"
"} module/insert/defer (name module) #@(name: module/insert cat: :modules internal: #t) #{##(tree/set! module/cache name module)\n"
"0E000E010E020E03040301\n"
"} module/insert (parts ret) #@(name: module/resolve-string/join cat: :modules internal: #t) #{##(parts ret \"\" \".\" #f module/resolve-string/join \"..\" throw \"Invalid path\" current-lambda otherwise)\n"
...
"} module/resolve-string/join (name wd) #@(name: module/resolve-string cat: :modules internal: #t) #{##(wd mod-path module/resolve-string/join nreverse append split \"/\" name parts string->keyword join \"\")\n"
"0E0007010D0E020E030E040E050E011A0604020E050E071A0604020402040124\n"
"040207080D0E090E0A1A0B0E08141A060402040101\n"
"} module/resolve-string (name env) #@(name: module/load cat: :modules internal: #t) #{##(type-of name ΓεnΣym-33 :environment :string module/load module/resolve-string resolve *module-path* env :keyword module/load/cache module/load/store module/load/external #f throw \"Can't load that value as a module\" current-lambda)\n"
...
"} module/load (module symbol) #@(name: module/import-all cat: :modules internal: #t) #{##(resolve exports module type-of :tree throw :type-error \"Expected a value of type :tree\" current-lambda)\n"
"0E001A010E02040207010D0E030E0104011A04200B0007240900130E051A061A\n"
"070E010E0804002E0404010D0E010101\n"
"} module/import-all (module symbol) #@(name: module/import cat: :modules internal: #t) #{##(module/import-all module symbol exports tree/has? throw :import-error resolves? \"That symbol was not exported\" \"That symbol does not exist in that module\" current-lambda)\n"
...
"} defmodule/defer (name value) #@(name: export) #{##(tree/set! exports quote name value)\n"
...
"17076301\n"
"}#{##((a) #@(documentation: \"Return #t if a is the last pair in a list\" name: last? source: (:inline \"Return #t if a is the last pair in a list\" (nil? (cdr a))) inline: #t) #{##(nil? a)\n"
"0E000E0112040101\n"
"} last? (a) #@(documentation: \"Return #t if a is positive\" name: pos? source: (:inline \"Return #t if a is positive\" (and (number? a) (>= a 0.0))) inline: #t) #{##(number? a 0.0)\n"
"0E000E0104010C0B00090D0E011A022101\n"
"} pos? (a) #@(documentation: \"Return #t if a is zero or negative\" name: zero-neg? source: (:inline \"Return #t if a is zero or negative\" (<= a 0.0)) inline: #t) #{##(a 0.0)\n"
"0E001A011F01\n"
"} zero-neg? (a) #@(documentation: \"Returns #t if a is negative\" name: neg? source: (:inline \"Returns #t if a is negative\" (< a 0.0)) inline: #t) #{##(a 0.0)\n"
"0E001A011E01\n"
...
"} even? (val) #@(documentation: \"#t if VAL is not zero\" name: not-zero? source: (:inline \"#t if VAL is not zero\" (not= 0 val)) inline: #t) #{##(not= val)\n"
"0E0002000E01040201\n"
"} not-zero? (val-a val-b) #@(documentation: \"Test whether two values are equal\\n\\nUnlike = this is actually comparing the contents of compound data,\\nwhich can be very slow.\\n\\nval-a: The first argument\\nval-b: The second argument\\n\\nWhether the two arguments are equal?\" name: equal? cat: :predicate tests: ((#t (equal? (array/new '(1 2 3) '(4.0 5.0 (tree/new :a 1 :b 2)) '(\"7\" (array/new 8 88) :9)) (array/new '(1 2 3) '(4.0 5.0 (tree/new :a 1 :b 2)) '(\"7\" (array/new 8 88) :9)))) (#t (equal? '(1 :b \"c\" (array/new 4.0)) '(1 :b \"c\" (array/new 4.0)))) (#f (equal? '(1 :b \"c\" (array/new 4.0)) '(1 :b \"c\"))) (#t (equal? '(1 :b \"c\") '(1 :b \"c\"))) (#f (equal? :a :b)) (#t (equal? :a :a)) (#f (equal? 2.0 2.1)) (#t (equal? 2.0 2.0)) (#t (equal? 1 1)))) #{##(type-of val-a cur-type not= val-b ΓεnΣym-2 :array array/equal? :tree tree/equal? :pair list/equal?)\n"
...
"}#{##((l depth) #@(name: quasiquote-real) #{##(l :pair type-of unquote-splicing depth append quasiquote-real unquote quasiquote cons :symbol quote)\n"
...
"0E000E010200040201\n"
"} quasiquote (expr) #@(name: unquote) #{##(throw :unquote-without-quasiquote \"unquote should only occur inside a quasiquote, never evaluated directly\")\n"
"0E001A011A022E02040101\n"
"} unquote (expr) #@(name: unquote-splicing) #{##(throw :unquote-splicing-without-quasiquote \"unquote-splicing should only occur inside a quasiquote, never evaluated directly\")\n"
"0E001A011A022E02040101\n"
"} unquote-splicing)\n"
"151A001A011A021707030D1A041A051A061807071607070D1A081A091A0A1707\n"
"0B0D1A0C1A0D1A0E17070F01\n"
"}#{##(3.141593 PI π (x) #@(documentation: \"Return a number 1 greater than x\" name: inc source: (:inline \"Return a number 1 greater than x\" (+ 1 x)) inline: #t) #{##(x)\n"
"02010E002501\n"
"} inc (x) #@(documentation: \"Return a number 1 less than x\" name: dec source: (:inline \"Return a number 1 less than x\" (- x 1)) inline: #t) #{##(x)\n"
"0E0002012601\n"
...
"040204090900042401\n"
"} describe/closure (#nil) #@(name: stacktrace) #{##(print describe/closure closure/caller current-lambda)\n"
"0E000E010E020E03040004010401040101\n"
"} stacktrace (i v) #@(name: print/error/wrap) #{##(i ΓεnΣym-10 v string/write describe/closure string)\n"
...
"} closure/name (o) #@(documentation: \"Describe a specific value O\" name: describe/thing) #{##(closure/documentation o documentation closure/name name print fmt-arg-0 cat \"(\" closure/arguments arguments :pair type-of ΓεnΣym-23 arg \" \" println \")\" \" . \" \"\\n\")\n"
...
"} describe/thing (a) #@(documentation: \"Descibe whatever value string A resolves to\" name: describe/string) #{##(describe/thing resolve string->symbol a)\n"
"0E000E010E020E0304010401040101\n"
"} describe/string (fun) #@(documentation: \"Describe FUN, if there is documentation available\" name: describe) #{##(:string type-of fun describe/string describe/thing)\n"
...
"} whitespace? l #@(documentation: \"Turn the provided char codes into a string and return it\" name: from-char-code) #{##(buffer/allocate list/length l buf i :int type-of 255 #f throw :type-error \"(from-char-code) expects :int arguments from 0 to 255, not: \" current-lambda buffer/set! buffer/length buffer->string)\n"
"0E000E010E020401040107030D020007040D240900630D1A050E060E02110401\n"
"200B00071C0900041B0C0A001C0D0E02111A07220C0A00110D0E021102001E0C\n"
"0A00060D1A080B00170E091A0A1A0B0E02110E0C04002E040401090004240D0E\n"
"0D0E030E040E021104030D0E021205020D0E042305040E040E0E0E0304011E0A\n"
"FF970D0E0F0E03040101\n"
"} from-char-code)\n"
"1A001A011A021707030D1A041A051A061707070D1A081A091A0A17070B0D1A0C\n"
"1A0D1A0E17070F01\n"
...
"} fmt/find-non-digit-from-right (opts spec) #@(name: fmt/parse-spec) #{##(buffer/length spec opts ΓεnΣym-6 #f fmt/find-non-digit-from-right next-non-digit string/cut number tree/set! :width read/single :padding-char \"0\" fmt/parse-spec :debug :base :HEXADECIMAL :hexadecimal :decimal :octal :binary :align :left :center :right :precision throw :format-error \"Unknown form-spec option\" current-closure)\n"
...
"0404011601\n"
"} fmt/parse-spec (opts) #@(name: fmt/debug) #{##(opts :debug tree/set! :argument string/write)\n"
"0E001A012B0B00170E020E001A030E040E001A032B2E0204030900050E0001\n"
"} fmt/debug (opts) #@(name: fmt/number-format) #{##(opts :base ΓεnΣym-36 :binary tree/set! :argument int->string/binary :octal int->string/octal :decimal int->string/decimal :hexadecimal int->string/hex :HEXADECIMAL int->string/HEX)\n"
...
"} fmt/number-format :binary \"#b\" :octal \"#o\" :decimal \"#d\" :hexadecimal \"#x\" :HEXADECIMAL fmt/number-format-prefixex (opts) #@(name: fmt/number-format-prefix) #{##(opts :debug :base #f tree/set! fmt/number-format-prefixex :argument cat)\n"
...
"} fmt/number-format-prefix (opts) #@(name: fmt/add-padding) #{##(opts :width tree/set! :argument :align ΓεnΣym-56 :right pad-start :center pad-middle :left pad-end :debug :base :padding-char)\n"
...
"} fmt/add-padding (opts) #@(name: fmt/precision) #{##(opts :precision tree/set! :argument string/round)\n"
"0E001A012B0B001C0E020E001A030E040E001A032B0E001A012B2E0304030900\n"
"050E0001\n"
"} fmt/precision (opts) #@(name: fmt/truncate) #{##(opts :width tree/set! :argument string/cut)\n"
"0E001A012B0B00210E020E001A030E040E001A032B020002010E001A012B252E\n"
"0404030900050E0001\n"
"} fmt/truncate (opts) #@(name: fmt/output) #{##(opts :argument)\n"
"0E001A012B01\n"
"} fmt/output (spec argument) #@(name: fmt/format-arg) #{##(fmt/output fmt/debug fmt/number-format-prefix fmt/truncate fmt/add-padding fmt/precision fmt/number-format tree/set! fmt/parse-spec tree/dup fmt/format-arg/default spec :argument argument)\n"
"0E000E010E020E030E040E050E060E070E080E090E0A04010E0B04021A0C0E0D\n"
"0403040104010401040104010401040101\n"
"} fmt/format-arg (argument) #@(name: fmt/valid-argument?) #{##(:int type-of argument :symbol #f)\n"
"1A000E010E020401200C0A00140D1A030E010E020401200C0A00060D1A0401\n"
"} fmt/valid-argument? (v) #@(name: fmt/arg-sym) #{##(type-of v ΓεnΣym-73 :int fmt/arg-sym cat \"fmt-arg-\" string :symbol :string string->symbol throw :type-error \"Invalid fmt argument name\" current-lambda)\n"
...
"} fmt/expr (format-string . args) #@(documentation: \"Return a formatted string\" name: fmt) #{##(:string type-of format-string throw :type-error \"fmt needs a string literal as a first argument, since it is implemented as a macro\" current-lambda cuts i ΓεnΣym-94 :int :format-error \"fmt placeholders can't be nested\" \"fmt expects all brackets to be closed\" buffer/length expr-list last-pos array/fill! array/allocate length args arguments-used tree/new :expr-count array/length opts ΓεnΣym-95 c string/cut lit \"\" fmt/expr expr \"fmt expects all arguments to be used\" cat string fmt/args/map-fun/count (arg) #@(name: fmt/args/map-fun) #{##(string->symbol cat \"fmt-arg-\" string fmt/args/map-fun/count s def arg)\n"
"0E000E011A020E030E0404010402040107050D0E0402012505040D1A060E050E\n"
"072E0301\n"
"} fmt/args/map-fun let* append map)\n"
"1A000E010E020401200B0007240900130E031A041A050E020E0604002E040401\n"
"0D2407070D020007080D240900820D150E020E082B07090D0E09027B200B002F\n"
"1A0A0E010E07110401200B00160E031A0B1A0C0E020E0604002E040401090004\n"
"240D0E080E0714050709003D0E09027D200B00341A0A0E010E07110401200B00\n"
"07240900130E031A0B1A0D0E020E0604002E0404010D0E07110E08140E071214\n"
"050709000424160D0E082305080E080E0E0E0204011E0AFF780D240D1A0A0E01\n"
"0E07110401200B00160E031A0B1A0C0E020E0604002E040401090004240D2407\n"
"0F0D0E0E0E02040107100D0E110E120E130E14040104011C040207150D0E161A\n"
"170E180E150401040207190D150E07071A0D2409005C0D0E1A11071B0D0E1C0E\n"
"020E1B120201250E100403071D0D1A1E0E1D200B00072409000A0E1D0E0F1405\n"
"0F0D0E1F0E1C0E0202010E1B11250E1B1204030E150E19040307200D0E200E0F\n"
"14050F0D0E1B1105100D0E1A12051A0E1A0AFFA50D24160D0E100200220B001A\n"
"0E1C0E0202000E100403071D0D0E1D0E0F14050F090004240D020007080D2409\n"
"002D0D0E150E082B0B00072409001A0E031A0B1A210E020E140E082B2E020E06\n"
"04002E0404010D0E082305080E080E180E1504011E0AFFCD0D240D0E0F120B00\n"
"0B1A220E0F1409001B1A000E010E0F110401200B00090E0F110900081A230E0F\n"
"1407200D020007240D1A251A261A271707280D0E140B00191A290E2A0E2B0E14\n"
"0E2804020E2024140402140900050E2001\n"
...
"}#{##((ext) #@(documentation: \"Return a predicate that checks if a path ends on EXT\" name: path/ext?!) #{##(type-of ext ΓεnΣym-1 :string (path) #@(name: anonymous) #{##(ext lower-case path/extension path)\n"
...
"150E000E01040107020D0E021A03200B000D1A041A051A06170900250E021A07\n"
"200B000D1A081A051A09170900130E0A1A0B1A0C0E010E0D04002E0404011601\n"
"} path/ext?! (path) #@(documentation: \"Return the extension of PATH\" name: path/extension) #{##(last-index-of path \".\" last-period string/cut buffer/length)\n"
"0E000E011A02040207030D0E030200210B00170E040E0102010E03250E050E01\n"
"040104030900050E0101\n"
"} path/extension (path) #@(documentation: \"Return PATH, but without the extension part\" name: path/without-extension) #{##(last-index-of path \".\" last-period string/cut)\n"
"0E000E011A02040207030D0E030200210B00100E040E0102000E030403090005\n"
"0E0101\n"
"} path/without-extension (path) #@(documentation: \"Return the directory part of a PATH\" name: path/dirname) #{##(last-index-of path \"/\" last-slash string/cut \"\")\n"
"0E000E011A02040207030D0E030200210B00100E040E0102000E030403090005\n"
"1A0501\n"
"} path/dirname (path) #@(documentation: \"Return the path without the directory part\" name: path/basename) #{##(last-index-of path \"/\" last-slash string/cut)\n"
"0E000E011A02040207030D0E030200210B00110E040E0102010E032504020900\n"
"050E0101\n"
"} path/basename)\n"
"1A001A011A021707030D1A041A051A061707070D1A081A091A0A17070B0D1A0C\n"
"1A0D1A0E17070F0D1A101A111A1217071301\n"
"}#{##(make-output-port make-string-output-port make-input-port buffer/allocate temporary-buffer buffer/u8* temporary-buffer-view tree/new :flush-output (handle) #@(name: anonymous) #{##(file/flush* handle)\n"
"0E000E01040101\n"
...
"0E0001\n"
"} input-port-method-table (handle) #@(documentation: \"Create a new output port for HANDLE\" name: anonymous) #{##((method . args) #@(name: anonymous) #{##(apply output-port-method-table method handle args)\n"
"0E000E010E022B0E030E0414040201\n"
"})\n"
"1A001A011A021701\n"
"} (#nil) #@(documentation: \"Create a new string output port\" name: anonymous) #{##(self (method . args) #@(name: anonymous) #{##(apply string-out-methods method self args)\n"
"0E000E010E022B0E030E0414040201\n"
"} meta! :buffer buffer/allocate 128 :position)\n"
"2407000D1A011A021A031705000D0E040E001A050E061A07040104030D0E040E\n"
"001A080200040301\n"
"} (handle) #@(documentation: \"Create a new input port for HANDLE\" name: anonymous) #{##((method . args) #@(name: anonymous) #{##(apply input-port-method-table method handle args)\n"
"0E000E010E022B0E030E0414040201\n"
"})\n"
"1A001A011A021701\n"
...
"4C17074D01\n"
"}#{##((α) #@(documentation: \"Turn α into a its **binary** string representation\" name: int->string/binary) #{##(\"\" ret α #f \"0\" cat from-char-code bit-and bit-shift-right not=)\n"
...
"} int->string/binary (α) #@(documentation: \"Turn α into a its **octal** string representation\" name: int->string/octal) #{##(\"\" ret α #f \"0\" cat from-char-code bit-and bit-shift-right not=)\n"
"1A0007010D0E020B00071C0900041B0C0A000E0D0E022A0C0A00060D1A030B00\n"
...
"0E000E01040101\n"
"} int->string/decimal int->string (v port hr?) #@(name: write/raw/array) #{##(port block-write \"##(\" i write/raw v hr? array/length \" \" \")\")\n"
"0E001A011A0204020D020007030D240900330D0E040E050E032B0E000E060403\n"
"0D0E030E070E0504010201261E0B000E0E001A011A080402090004240D0E0323\n"
"05030E030E070E0504011E0AFFC70D240D0E001A011A09040201\n"
"} write/raw/array (v port hr?) #@(name: write/raw/buffer) #{##(hr? port write \"#<buffer :id \" int->string/decimal val->id v \" :size \" int->string/hex buffer/length \">\" block-write \"#m\" buffer/u8* view i pad-start int->string/HEX \"0\")\n"
"0E000B00260E011A021A030E040E050E06040104011A070E080E090E06040104\n"
"011A0A040609004A0E011A0B1A0C04020D0E0D0E060401070E0D0200070F0D24\n"
"0900210D0E011A0B0E100E110E0E0E0F2B040102021A12040304020D0E0F2305\n"
"0F0E0F0E090E0604011E0AFFD90D2401\n"
"} write/raw/buffer (v port hr?) #@(name: write/raw/bytecode-array) #{##(port block-write \"#{\" write/raw/array bytecode-literals v i bit-and \"\\n\" pad-start int->string/HEX \"0\" bytecode-array/length \"\\n}\")\n"
"0E001A011A0204020D0E030E040E0504010E001C04030D020007060D2409003A\n"
"0D0E070E06021F04022A0B000E0E001A011A080402090004240D0E001A010E09\n"
"0E0A0E050E062B040102021A0B040304020D0E062305060E060E0C0E0504011E\n"
"0AFFC00D240D0E001A011A0D040201\n"
"} write/raw/bytecode-array (v port hr? always-space?) #@(name: write/raw/tree/rec) #{##(v tree/key* #f always-space? write/raw/tree/rec tree/left* port hr? block-write \" \" keyword->string \": \" write/raw tree/value* tree/right*)\n"
...
"} write/raw/tree (v port hr?) #@(name: write/raw/pair) #{##(quote v nil? :pair type-of port block-write \"'\" write/raw hr? \"(\" first? \" \" \". \" \")\")\n"
...
"11040209000B0E011A120E060402160D0E052305050E050E130E0304011E0AFF\n"
"070D240D0E011A021A04040201\n"
"} write/raw/string (v port hr?) #@(name: write/raw) #{##(type-of v ΓεnΣym-81 :nil hr? port block-write \"#nil\" :bool \"#t\" \"#f\" :environment write \"#<environment \" int->string/hex val->id \">\" :file-handle \"#<file-handle \" :buffer-view \"#<buffer-view \" :lambda :macro :native-function #f string closure/name anonymous :int int->string/decimal :float :keyword \":\" keyword->string :symbol :array write/raw/array :buffer write/raw/buffer :bytecode-array write/raw/bytecode-array :string write/raw/string :tree write/raw/tree :pair write/raw/pair \"\")\n"
"150E000E01040107020D0E021A03200B00170E040B00072409000B0E051A061A\n"
"07040209019F0E021A08200B00180E051A060E010B00081A090900051A0A0402\n"
"0901820E021A0B200B001A0E051A0C1A0D0E0E0E0F0E01040104011A10040409\n"
"01630E021A11200B001A0E051A0C1A120E0E0E0F0E01040104011A1004040901\n"
"440E021A13200B001A0E051A0C1A140E0E0E0F0E01040104011A100404090125\n"
...
"020900E10E021A1C200B00120E051A060E1D0E01040104020900CA0E021A1E20\n"
"0B00120E051A060E190E01040104020900B30E021A1F200B00140E051A0C1A20\n"
"0E210E010401040309009A0E021A22200B00120E051A060E190E010401040209\n"
"00830E021A23200B00100E240E010E050E04040309006E0E021A25200B00100E\n"
"260E010E050E0404030900590E021A27200B00100E280E010E050E0404030900\n"
"440E021A29200B00100E2A0E010E050E04040309002F0E021A2B200B00100E2C\n"
"0E010E050E04040309001A0E021A2D200B00100E2E0E010E050E040403090005\n"
"1A2F1601\n"
"} write/raw (v port) #@(name: write) #{##(write/raw v port stdout #f)\n"
"0E000E010E020C0A000D0D0E030C0A00060D1A041C040301\n"
"} write (v port) #@(name: display/new) #{##(write/raw v port stdout #f)\n"
"0E000E010E020C0A000D0D0E030C0A00060D1A041B040301\n"
"} display/new (v) #@(name: string/write) #{##(make-string-output-port p write/raw v :return-string)\n"
...
"0E000E010E020401040107030D020007040D2409001B0D0E050E030E040E060E\n"
"020E042B040104030D0E042305040E040E010E0204011E0AFFDF0D0E070E0304\n"
"0101\n"
...
"0E000E010E020401040107030D1B07040D020007050D240900390D0E060E030E\n"
"050E040B00080E070900050E080E020E052B040104030D0E090E020E052B0401\n"
"0B00071B0900041C05040D0E052305050E050E010E0204011E0AFFC10D0E0A0E\n"
"03040101\n"
"} capitalize (text decimal-digits) #@(documentation: \"Round the floating point representation in TEXT to have at most DECIMAL-DIGITS after the period\" name: string/round) #{##(last-index-of text \".\" pos string/cut decimal-digits)\n"
"0E000E011A02040207030D0E030200210B00160E040E0102000E030201250E05\n"
"2504030900050E0101\n"
"} string/round (str separator) #@(name: split/empty) #{##(buffer/length str slen start ret string/cut reverse)\n"
...
"01\n"
"} split/empty (str separator start) #@(name: split/string) #{##(start index-of str separator pos-found string/cut split/string buffer/length)\n"
...
"} split/string (str separator) #@(documentation: \"Splits STR into a list at every occurunse of SEPARATOR\" name: split) #{##(type-of str :string throw :type-error \"Expected a value of type :string\" current-lambda separator buffer/length ΓεnΣym-55 split/empty split/string)\n"
"0E000E0104011A02200B0007240900130E031A041A050E010E0604002E040401\n"
"0D0E000E0704011A02200B0007240900130E031A041A050E070E0604002E0404\n"
"010D150E080E07040107090D0E090200200B000C0E0A0E01040109000D0E0B0E\n"
"010E07020004031601\n"
"} split (text) #@(documentation: \"Uses the reader and returns the first single value read from string TEXT\" name: read/single) #{##(type-of text :string throw :type-error \"Expected a value of type :string\" current-lambda read)\n"
"0E000E0104011A02200B0007240900130E031A041A050E010E0604002E040401\n"
"0D0E070E0104011101\n"
