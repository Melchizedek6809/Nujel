...
"} tree/reduce (l f) #@(documentation: \"Return a new tree with all elements from L where F returns true\" name: tree/filter) #{##(tree/new ret tree/keys l ΓεnΣym-9 e t f)\n"
"0E0024040107010D150E020E03040107040D2409002C0D0E041107050D0E030E\n"
"052B07060D0E070E0604010B000D0E010E050E0637090004240D0E041205040E\n"
"040AFFD50D0E011601\n"
"} tree/filter (a b) #@(documentation: \"Merge two trees together, if a key is contained in both trees the on in B gets priority\" name: tree/merge) #{##(b a tree/dup tree/new ret tree/keys ΓεnΣym-14 k)\n"
...
"} $macro* (code sym-map pos) #@(name: assemble/build-sym-map) #{##(type-of code ΓεnΣym-81 :int sym-map :last-op pos :keyword ΓεnΣym-82 :label :relocate :literal :pair assemble/build-sym-map)\n"
"2409009A0D150E000E0111040107020D0E021A03200B00120E041A050E060201\n"
...
"} compile (name args body) #@(name: meta/parse/body cat: :compiler internal: #t) #{##(body source tree/new :name name meta v type-of ΓεnΣym-3 :pair deftest :tests :string :documentation cat string \"\\n\" :keyword ΓεnΣym-4 :inline :source :related :export-as :export :cat trim join map split)\n"
"0E0007010D0E021A030E04040207050D240900E70D0E001107060D150E070E06\n"
"040107080D0E081A09200B00230E06111A0A200B00140E051A0B0E06120E051A\n"
"0B2B14370900062405000900A70E081A0C200B001C0E051A0D0E0E0E0F0E051A\n"
"0D2B04011A100E060403370900860E081A11200B007D150E0607120D0E121A13\n"
"200B00140E050E061B370D0E051A140E013709005A0E121A15200B001A0E051A\n"
"150E002C0E051A152B14370D0E0012050009003B0E121A16200B00140E051A17\n"
"0E002C370D0E001205000900220E121A18200B00140E051A180E002C370D0E00\n"
"1205000900090E050E061B371609000424160D0E001205000E000AFF1A0D0E05\n"
"1A0D2B0B00260E051A0D0E190E1A0E1B0E1C0E051A0D2B1A1004020E1904021A\n"
"100402040137090004240D0E050101\n"
...
"} fmt/find-non-digit-from-right (opts spec) #@(name: fmt/parse-spec) #{##(buffer/length spec opts ΓεnΣym-6 #f fmt/find-non-digit-from-right next-non-digit string/cut number :width read/single :padding-char \"0\" fmt/parse-spec :debug :base :HEXADECIMAL :hexadecimal :decimal :octal :binary :align :left :center :right :precision :format-error \"Unknown form-spec option\" current-closure)\n"
"0E000E0104012A0B00080E02090271150E010E000E0104010201262B07030D0E\n"
...
"00060D1A040B00620E050E010E000E010401020126040207060D0E070E010201\n"
"0E06250E000E010401040307080D0E021A090E0A0E080401370D02300E080200\n"
"2B200B000D0E021A0B1A0C37090004240D0E0D0E020E070E01020002010E0625\n"
"040304020901980E03023F200B00210E0D0E021A0E1B370E070E0102000E000E\n"
"010401020126040304020901720E030258200B00220E0D0E021A0F1A10370E07\n"
"0E0102000E000E0104010201260403040209014B0E030278200B00220E0D0E02\n"
"1A0F1A11370E070E0102000E000E010401020126040304020901240E03026420\n"
"0B00220E0D0E021A0F1A12370E070E0102000E000E0104010201260403040209\n"
"00FD0E03026F200B00220E0D0E021A0F1A13370E070E0102000E000E01040102\n"
"0126040304020900D60E030262200B00220E0D0E021A0F1A14370E070E010200\n"
"0E000E010401020126040304020900AF0E03023C200B00220E0D0E021A151A16\n"
"370E070E0102000E000E010401020126040304020900880E03025E200B00220E\n"
"0D0E021A151A17370E070E0102000E000E010401020126040304020900610E03\n"
"023E200B00220E0D0E021A151A18370E070E0102000E000E0104010201260403\n"
"040209003A0E03022E200B00250E0D0E021A190E021A092B370E070E0102000E\n"
...
"01\n"
"} fmt/precision (opts) #@(name: fmt/truncate) #{##(opts :width :argument string/cut)\n"
"0E001A012B0B001E0E001A020E030E001A022B020002010E001A012B252E0437\n"
"0900050E0001\n"
"} fmt/truncate (opts) #@(name: fmt/output) #{##(opts :argument)\n"
"0E001A012B01\n"
"} fmt/output (spec argument) #@(name: fmt/format-arg) #{##(fmt/output fmt/debug fmt/number-format-prefix fmt/truncate fmt/add-padding fmt/precision fmt/number-format fmt/parse-spec tree/dup fmt/format-arg/default spec :argument argument)\n"
"0E000E010E020E030E040E050E060E070E080E0904010E0A04021A0B0E0C3704\n"
