...
"} path/working-directory +root-working-dir+ *module-path* module/loader/filesystem (name) #{##(keyword->string name name-string System/OS Windows string/cut fmt-arg-0 cat \".nuj\" module-path file/read source list module def *module* *module-path* path/dirname do read expr compile* current-closure mod)\n"
...
"07140D0E150E140E16040004020E1604001D07170D0E170101\n"
"} module/add-loader)\n"
