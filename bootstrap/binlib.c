...
"} popen/trim cwd +root-working-dir+ *module-path* (name) #@(name: module/loader/filesystem) #{##(:string name name-string System/OS Windows :cut fmt-arg-0 cat \".nuj\" module-path file/read source module def *module* *module-path* path/dirname do read expr compile* root-closure mod)\n"
