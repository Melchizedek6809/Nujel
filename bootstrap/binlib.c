...
"} push-result exports cmd/raw (line) #@(name: cmd/raw export: #t) #{##((err) #@(name: anonymous) #{##(err :unmatched-opening-bracket cmd/raw ctx cat line readline \"... \")\n"
...
"07080D1A091A0A1A0B17070C0D0E0D1A0E1A0F1A101A1117070E370D1A121A13\n"
"1A141707150D1A161A171A181707190D1A1A1A1B1A1C17071D0D1A1E1A1F1A20\n"
"17072116072101\n"
"}";