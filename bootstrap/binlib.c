...
"} init/parse-option [option] #{##[ref init/option-map option :default #f]\n"
"0E000E010E0204020C0A00130D0E000E011A0304020C0A00060D1A040E020401\n"
"01\n"
"} init/parse-options [options] #{##[buffer/ref options init/parse-option string->keyword cut for-each map split \"\" string->symbol]\n"
"0E000E0102000402022D200B00160E020E030E040E0102010402040104010900\n"
"170E050E060E070E011A0804020E0904020E02040201\n"
...
"} buffer/ref string/cut module/main string->keyword args exit init/parse-options [e] #{##[print/error e exit]\n"
"0E000E0104010D0E020201040101\n"
"} file/eval-module init/parse-args/run-repl]\n"
"0E000B001F0E011900170E020E030E040E050E0604011404020D1C0500160900\n"
"8F0E070B00441A081A091A0A1A0B171900350E0C0E0602000402023A200B0010\n"
"0E0D0E06020104020506090004240D0E0E0E0F0E0604010E101204020D0E1102\n"
"000401160900490E0C0E0602000402022D200B00120E120E0D0E060201040204\n"
"0109002C1B0B00271A081A131A0A1A14171900140E150E060E101204020D0E11\n"
"02000401160D1C05160900042401\n"
...
"0201\n"
"} file/eval-module [path args] #{##[module/resolve-string cat path/without-extension path path/working-directory mod-name module/load mod :environment type-of resolve exports throw list \"Couldn't load \" \" as a module since it has no exports\" current-lambda tree/has? :main tree/ref args]\n"
...
"110E0B1A1204020B00120E130E0B1A1204020E1404010900042401\n"
...
"0E00111A012001\n"
"} file/test/module [path base-dir] #@[documentation: \"Test a module by running all contained tests\"] #{##[string/cut path length base-dir rel-path buffer/ref string->keyword path/without-extension module-name module/import module/load :ansi current-closure blue :test init! finish! file/test/module/run filter read file/read file/test/valid-test-form?]\n"
"0E000E010E020E030401040207040D0E050E0402000402022F200B00100E000E\n"
"04020104020504090004240D0E060E070E040401040107080D0E090E0A1A0B0E\n"
"0C040004021A0D0402070D0D0E090E0A1A0E0E0C040004021A0F0402070F0D0E\n"
"090E0A1A0E0E0C040004021A10040207100D0E0F04000D0E110E120E130E140E\n"
"01040104010E1504020E0804020D0E100E0D0E080401040101\n"
...
"} file/file? [filename] #{##[ref file/stat filename :regular-file?]\n"
"0E000E010E0204011A03040201\n"
"} file/dir? [filename] #{##[ref file/stat filename :directory?]\n"
"0E000E010E0204011A03040201\n"
...
"} path/working-directory +root-working-dir+ *module-path* module/loader/filesystem [name] #{##[keyword->string name name-string buffer/ref System/OS Windows string/cut fmt-arg-0 cat \".nuj\" module-path file/read source list module def *module* *module-path* path/dirname do read expr eval-in current-closure mod]\n"
"0E000E01040107020D0E030E0202000402022F200B00072409000524010D0E04\n"
"1A05200B00100E060E02020104020502090004240D150E0207070D0E080E071A\n"
"09040216070A0D0E0B0E0A0401070C0D0E0C0B00072409000524010D0E0D1A0E\n"
"1A0F1A100E01241414141A0F1A110E120E0A0401241414140E130E140E0C0401\n"
"14040407150D0E160E1704000E15040207180D0E180101\n"
"} module/add-loader]\n"
