...
"} error (port buf) #@(documentation: \"Reads in a line of user input and returns it\" name: read-line/raw) #{##(i c buffer/u8* buf view buffer/length! 128 buffer/length port char-read :end-of-file)\n"
"020007000D020007010D0E020E03040107040D240900650D240900110D0E051A\n"
...
"} push-result tree/set! exports cmd/raw (line) #@(name: cmd/raw export: #t) #{##((err) #@(name: anonymous) #{##(err :unmatched-opening-bracket cmd/raw ctx cat line readline \"... \")\n"
