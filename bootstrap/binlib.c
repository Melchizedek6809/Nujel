...
"} :cut module/main string->keyword args exit init/parse-options (e) #{##(print/error e exit)\n"
"0E000E0104010D0E020201040101\n"
"} file/eval-module init/parse-args/run-repl)\n"
"0E000B001F0E011900170E020E030E040E050E0604011404020D1C0500160900\n"
"850E070B003F1A081A091A0A171900320E0602002B023A200B00101A0B0E0602\n"
"0104020506090004240D0E0C0E0D0E0604010E0E1204020D0E0F020004011609\n"
"00440E0602002B022D200B00120E101A0B0E0602010402040109002A1B0B0025\n"
...
"0E000E011A020E031A040E05040104020401040107060D1A070E061A081A090E\n"
...
"} popen/trim path/working-directory +root-working-dir+ *module-path* (name) #@(name: module/loader/filesystem) #{##(keyword->string name name-string System/OS Windows :cut fmt-arg-0 cat \".nuj\" module-path file/read source module def *module* *module-path* path/dirname do read expr compile* current-closure mod)\n"
...
"}#{##((host path) #@(name: http/get*) #{##(cat \"GET \" path \" HTTP/1.0\\r\\n\\r\\n\" req buffer/allocate buf socket/connect host fh file/write* :length file/flush* bytes-read bytes-read-now :length! 65536 file/read* file/close* buffer->string raw-res :index-of \"\\r\\n\" eosl \"\\r\\n\\r\\n\" eoh status-line split \" \" status-list tree/new headers header-raw header-lines ΓεnΣym-1 header \":\" eok string->keyword :cut key trim v body :http-version :status-code read/int :status-message join :headers :body)\n"
"0E001A010E021A03040307040D0E050200040107060D0E070E08025004020709\n"
"0D0E0A0E090E041A0B0E04040104030D0E0C0E0904010D0200070D0D0201070E\n"
"0D2409002A0D1A0F0E061A101A0B0E0604012504020D0E110E090E061A100E0D\n"
"0404050E0D0E0D0E0E25050D0E0E2A0B00071C0900041B0AFFCE0D0E120E0904\n"
"010D0E130E060E0D040207140D1A150E141A16040207170D0E1702001E0B0008\n"
"2401090004240D1A150E141A18040207190D0E1902001E0B0008240109000424\n"
"0D0E130E060E170402071A0D0E1B0E1A1A1C0402071D0D0E1E240401071F0D0E\n"
"130E060E1902020E1725040307200D0E1B0E201A16040207210D150E2107220D\n"
"240900510D0E221107230D1A150E231A24040207250D0E250200210B00300E26\n"
"1A270E2302000E250403040107280D0E291A270E2302010E252504020401072A\n"
"0D0E1F0E280E2A37090004240D0E221205220E220AFFB00D24160D1A270E0602\n"
"040E19250402072B0D0E1E1A2C0E1D111A2D0E2E0E1D2C04011A2F0E300E1D12\n"
"121A1C04021A310E1F1A320E2B040A01\n"
"} http/get* (url) #@(name: http/get) #{##(:index-of url \"https://\" error \"https is unsupported right now\" \"http://\" :cut \"/\" path-start http/get* \"unsupported scheme\")\n"
"1A000E011A0204020200210B000C0E031A040401090004240D1A000E011A0504\n"
"020200210B00461A060E010207040205010D1A000E011A07040207080D0E0802\n"
"00210B001C0E091A060E0102000E0804031A060E010E080402040209000B0E09\n"
"0E011A07040201090004240D0E031A0A040101\n"
"} http/get)\n"
