...
"0104020506090004240D0E0C1A0D0E0604010E0E1204020D0E0F020004011609\n"
...
"} popen/trim path/working-directory +root-working-dir+ *module-path* (name) #@(name: module/loader/filesystem) #{##(:string name name-string System/OS Windows :cut fmt-arg-0 cat \".nuj\" module-path file/read source module def *module* *module-path* path/dirname do read expr compile* current-closure mod)\n"
