...
"01\n"
"} init/parse-options (options) #{##(ref options init/parse-option string->keyword cut for-each map split \"\" string->symbol)\n"
...
"} ref string/cut module/main string->keyword args exit init/parse-options (e) #{##(print/error e exit)\n"
"0E000E0104010D0E020201040101\n"
...
"0201\n"
"} file/eval-module (path args) #{##(module/resolve-string cat path/without-extension path path/working-directory mod-name module/load mod :environment type-of resolve exports throw list \"Couldn't load \" \" as a module since it has no exports\" current-lambda tree/has? :main ref args)\n"
...
"0E00111A012001\n"
"} file/test/module (path base-dir) #@(documentation: \"Test a module by running all contained tests\") #{##(string/cut path length base-dir rel-path ref string->keyword path/without-extension module-name module/import module/load :ansi current-closure blue :test init! finish! file/test/module/run filter read file/read file/test/valid-test-form?)\n"
...
"} path/working-directory +root-working-dir+ *module-path* module/loader/filesystem (name) #{##(keyword->string name name-string ref System/OS Windows string/cut fmt-arg-0 cat \".nuj\" module-path file/read source list module def *module* *module-path* path/dirname do read expr eval-in current-closure mod)\n"
