...
extern lSymbol *symNull,*symQuote,*symQuasiquote, *symUnquote, *symUnquoteSplicing, *symArr,*symIf,*symCond,*symLet,*symDo,*symMinus,*symLambda,*symLambdAst,*symTreeNew;
